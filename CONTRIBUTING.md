...
java -jar target/nuts-release-tool-0.8.8.0.jar
```
...
* working on existing issues. The issues are marked with labels. The priority is given always to the current version milestone (example 0.8.8).
