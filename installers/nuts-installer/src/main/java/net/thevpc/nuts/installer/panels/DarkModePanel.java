...
//    JPanel panel;
//    JEditorPane jep;
//    ButtonInfo lightButtonInfo;
//    ButtonInfo darkButtonInfo;
...
//        bg = new ButtonGroup();
//        lightButtonInfo = new ButtonInfo("Light Mode", "<html><body>Selected <strong>light mode</strong></body></html>", InstallPalette.themeLightButtonLightTheme, InstallPalette.themeLightButtonDarkTheme, UiHelper2.getCheckedImageIcon(false), UiHelper2.getCheckedImageIcon(true));
//        lightModeButton = add2(lightButtonInfo);
//        darkButtonInfo = new ButtonInfo("Dark Mode", "<html><body>Selected <strong>dark mode</strong></body></html>", InstallPalette.themeDarkButtonLightTheme, InstallPalette.themeDarkButtonDarkTheme, UiHelper2.getCheckedImageIcon(false), UiHelper2.getCheckedImageIcon(true));
//        darkModeButton = add2(darkButtonInfo);
...
//        lightButtonInfo.setDarkMode(id.darkMode);
//        darkButtonInfo.setDarkMode(id.darkMode);
