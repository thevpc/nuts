module.exports = {
  someSidebar: {
    Nuts: ['intro/introduction', 'intro/projects', 'intro/building', 'intro/license'],
    'Getting Started': ['get-started/installation', 'get-started/commandline', 'get-started/faq'],
    'Application Framework': ['fwk/nutsApp','fwk/firstNutsApp'],
    'API Reference': [
