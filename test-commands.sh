...
#nuts-dev bundle -y net.thevpc.nops:nops --lib=com.cts.ops:cts-ops#1.0,com.cts.ops:cts-protos#1.0,com.cts.ops:icon-misa-ops#1.0,com.cts.ops:icon-veoni-ops#1.0,nsh,nuts-ssh,net.thevpc.nops:nops-desktop-lib,com.avidea.ops:avidea-ops
#
#
