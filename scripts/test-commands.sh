...
rm -Rf nuts-0.8.7/*
java -jar nuts-0.8.7-bundle.jar
...
#-ZyS --verbose -y net.thevpc.nuts-spring-boot-admin:nuts-spring-boot-admin
#
nuts -ZySb --stacktrace --color=formatted nsh -c ls -l ssh://vpc@thevpc.net/

cd /home/vpc/xprojects/nuts-world/nuts/
