...
public interface NutsCommandLineProcessor {
 ...
 the "next" methods to
     ...
     */
    default boolean onCmdNextOption(NutsArgument option, NutsCommandLine commandLine, NutsCommandLineContext context){
        return false;
    }
     ...
     * @return true if the argument can be processed, false otherwise.
     */
    default boolean onCmdNextNonOption(NutsArgument nonOption, NutsCommandLine commandLine, NutsCommandLineContext context){
        return false;
    }
     ...
     * @param context session
     */
    default void onCmdInitParsing(NutsCommandLine commandLine, NutsCommandLineContext context) {
     ...
     * @param context session
     */
    default void onCmdFinishParsing(NutsCommandLine commandLine, NutsCommandLineContext context) {
     ...
     * @param context session
     */
    void onCmdExec(NutsCommandLine commandLine, NutsCommandLineContext context);
     ...
     * @param context session
     */
    default void onCmdAutoComplete(NutsCommandAutoComplete autoComplete, NutsCommandLineContext context) {
