...
public final class NReservedGuiUtils {
    ...
    public static String inputString(String message, String title, Supplier<String> in, NLogger bLog) {
        try {
            if (title == null) {
    ...
    public static void showMessage(String message, String title, NLogger bLog) {
        if (title == null) {
