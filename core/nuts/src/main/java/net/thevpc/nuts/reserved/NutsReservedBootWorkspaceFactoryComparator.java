 ...
 */
public final class NutsReservedBootWorkspaceFactoryComparator implements Comparator<NutsBootWorkspaceFactory> {

    private final NutsWorkspaceBootOptions options;

    public NutsReservedBootWorkspaceFactoryComparator(NutsWorkspaceBootOptions options) {
