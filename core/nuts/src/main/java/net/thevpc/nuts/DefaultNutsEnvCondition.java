...
public class DefaultNutsEnvCondition implements NutsEnvCondition {
    ...
    public DefaultNutsEnvCondition(NutsEnvCondition d) {
        this(
                d.getArch(),
                d.getOs(),
                d.getOsDist(),
    ...
    public DefaultNutsEnvCondition() {
        this(null, null, null, null, null, null, null);
    }

    public DefaultNutsEnvCondition(List<String> arch, List<String> os, List<String> osDist,
