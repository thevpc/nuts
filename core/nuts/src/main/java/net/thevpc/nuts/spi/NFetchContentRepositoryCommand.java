 ...
 * @since 0.5.5
 */
public interface NFetchContentRepositoryCommand extends NRepositoryCommand {
     ...
     */
    NFetchContentRepositoryCommand setId(NId id);
     ...
     */
    @Override
    NFetchContentRepositoryCommand setSession(NSession session);
     ...
     */
    @Override
    NFetchContentRepositoryCommand run();
     ...
     * @return {@code this} instance
     */
    NFetchContentRepositoryCommand setDescriptor(NDescriptor descriptor);
