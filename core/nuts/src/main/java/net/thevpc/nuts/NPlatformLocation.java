...
public class NPlatformLocation extends NConfigItem {
    ...
    public NPlatformLocation(NId id, String product, String name, String path, String version, String packaging, int priority) {
        this.id = id;
        this.platformType = (id == null || NBlankable.isBlank(id.getArtifactId())) ? NPlatformFamily.JAVA :
                NPlatformFamily.parse(id.getArtifactId()).orElse(NPlatformFamily.UNKNOWN);
