...
public interface NutsRm extends NutsComponent<Object> {
     ...
     */
    NutsRm setTarget(Object target);
     ...
     * @return {@code this} instance
     */
    NutsRm setSession(NutsSession session);
     ...
     * @return {@code this} instance
     */
    NutsRm setFailFast(boolean failFast);
