 ...
 * @author thevpc
 */
public final class NutsWorkspaceTerminalOptions {
    private final InputStream in;
    private final PrintStream out;
    private final PrintStream err;
    private final Set<String> flags;

    public NutsWorkspaceTerminalOptions(InputStream in, PrintStream out, PrintStream err, String... flags) {
        this.in = in;
        this.out = out;
        this.err = err;
    ...
    public boolean equals(Object o) {
        ...
        NutsWorkspaceTerminalOptions that = (NutsWorkspaceTerminalOptions) o;
