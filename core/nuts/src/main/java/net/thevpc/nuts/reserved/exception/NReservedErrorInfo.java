...
public class NReservedErrorInfo {
    private final NId nutsId;
    private final String repository;
    private final String url;
    private final String message;
    private final Throwable throwable;

    public NReservedErrorInfo(NId nutsId, String repository, String url, String message, Throwable throwable) {
        this.nutsId = nutsId;
    ...
    public String toString() {
        ...
        if(!NBlankable.isBlank(getMessage())){
