...
public class PrivateNutsWorkspaceOptionsArgumentsBuilder {
    private NutsWorkspaceOptionsConfig config;
    private NutsWorkspaceOptions options;

    public PrivateNutsWorkspaceOptionsArgumentsBuilder(NutsWorkspaceOptionsConfig config, NutsWorkspaceOptions options) {
        this.config = config;
    ...
    public NutsCommandLine toCommandLine() {
        ...
        if (apiVersionObj == null || apiVersionObj.compareTo("0.8.4") >= 0) {
            ...
            fillOption("--isolation", null, options.getIsolation().orNull(), NutsWorkspaceIsolation.class, arguments, false);
