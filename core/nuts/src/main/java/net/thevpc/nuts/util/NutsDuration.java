...
public class NutsDuration implements Serializable, NutsFormattable {
    private long nanos;
    private long micros;
    ...
    @NutsMapBy
    public NutsDuration(
            @NutsMapBy(name = "years") long years,
            @NutsMapBy(name = "months") long months,
            @NutsMapBy(name = "weeks") long weeks,
            @NutsMapBy(name = "days") long days,
            @NutsMapBy(name = "hours") long hours,
            @NutsMapBy(name = "minutes") long minutes,
            @NutsMapBy(name = "seconds") long seconds,
            @NutsMapBy(name = "milliSeconds") long milliSeconds,
            @NutsMapBy(name = "micros") long micros,
    ...
    public NutsDuration(long[] values, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
    ...
    public NutsDuration(long timeMillis, int timeNanos) {
    ...
    public NutsDuration(long timeMillis, int timeNanos, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        this.timeMillis = timeMillis;
        this.timeNanos = timeNanos;
    ...
    public static NutsDuration ofNanos(long durationNanos) {
        long ms = durationNanos / 1000000;
        int ns = (int) (durationNanos % 1000000);
        return new NutsDuration(ms, ns);
    }

    public static NutsDuration ofNanos(long durationNanos, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        long ms = durationNanos / 1000000;
        int ns = (int) (durationNanos % 1000000);
    ...
    public static NutsDuration ofMillis(long durationMillis, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        return new NutsDuration(durationMillis, 0, smallestUnit, largestUnit);
    }

    public static NutsDuration ofDuration(Duration duration) {
    ...
    public static NutsDuration ofMillisAndNanos(long durationMillis, int nanos) {
        return new NutsDuration(durationMillis, nanos);
    }

    public static NutsDuration of(long[] values, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        return new NutsDuration(values, smallestUnit, largestUnit);
    }

    public static NutsDuration of(long[] values) {
        return of(values, null, null);
    }

    public static NutsDuration ofSecondsAndNanos(long durationSeconds, long nanos) {
    ...
    public NutsDuration withSmallestUnit(ChronoUnit smallestUnit) {
        NutsDuration d = new NutsDuration(toUnitsArray(), smallestUnit, largestUnit);
    ...
    public NutsDuration withLargestUnit(ChronoUnit largestUnit) {
        NutsDuration d = new NutsDuration(toUnitsArray(), smallestUnit, largestUnit);
        if (this.timeMillis != d.timeMillis || this.timeNanos != d.timeNanos) {
            throw new IllegalArgumentException("unexpected");
        }
    ...
    public NutsDuration withUnits(ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        NutsDuration d = new NutsDuration(toUnitsArray(), smallestUnit, largestUnit);
        if (this.timeMillis != d.timeMillis || this.timeNanos != d.timeNanos) {
            throw new IllegalArgumentException("unexpected");
        }
    ...
    public NutsDuration add(NutsDuration other) {
        long[] a = toUnitsArray();
    ...
    public NutsDuration subtract(NutsDuration other) {
        long[] a = toUnitsArray();
        long[] b = other.toUnitsArray();
        for (int i = 0; i < a.length; i++) {
            a[i] -= b[i];
    ...
    public NutsDuration normalize() {
        ...
        NutsDuration d = new NutsDuration(values, smallestUnit, largestUnit);
        if (this.timeMillis != d.timeMillis || this.timeNanos != d.timeNanos) {
            throw new IllegalArgumentException("unexpected");
        }
        return d;
    ...
    public String toString(NutsDurationFormatMode formatMode) {
        return DefaultNutsDurationFormat.of(formatMode).format(this);
    }

    @Override
    public String toString() {
        return DefaultNutsDurationFormat.DEFAULT.format(this);
    }
