 ...
 * @app.category Base
 */
public interface NWorkspaceEnvManager extends NComponent {
    static NWorkspaceEnvManager of(NSession session) {
        return NExtensions.of(session).createSupported(NWorkspaceEnvManager.class);
    }
     ...
     * @since 0.8.1
     */
    NWorkspaceEnvManager setProperty(String property, Object value);
    ...
    NWorkspaceEnvManager setSession(NSession session);
