...
public class NutsReservedWorkspaceOptionsArgumentsBuilder {
    private NutsWorkspaceOptionsConfig config;
    private NutsWorkspaceOptions options;

    public NutsReservedWorkspaceOptionsArgumentsBuilder(NutsWorkspaceOptionsConfig config, NutsWorkspaceOptions options) {
        this.config = config;
    ...
    private void fillOption(String longName, String shortName, Enum value, Class enumType, List<String> arguments, boolean forceSingle) {
        ...
        if (value != null) {
            ...
            if (value instanceof NutsSupportMode && (apiVersionObj == null || apiVersionObj.compareTo("0.8.4") < 0)) {
                switch ((NutsSupportMode) value) {
                    case ALWAYS: {
            ...
            if (value instanceof NutsEnum) {
                fillOption0(selectOptionName(longName, shortName), ((NutsEnum) value).id(), arguments, forceSingle);
            } else {
    ...
    public NutsCommandLine toCommandLine() {
        ...
        if (!(config.isOmitDefaults() && options.getTerminalMode().orNull() == NutsTerminalMode.FORMATTED)) {
        ...
        if (apiVersionObj == null || apiVersionObj.compareTo("0.8.4") >= 0) {
            ...
            fillOption("--desktop-launcher", null, options.getDesktopLauncher().orNull(), NutsSupportMode.class, arguments, false);
            fillOption("--menu-launcher", null, options.getDesktopLauncher().orNull(), NutsSupportMode.class, arguments, false);
            fillOption("--user-launcher", null, options.getDesktopLauncher().orNull(), NutsSupportMode.class, arguments, false);
            fillOption("--isolation-level", null, options.getIsolationLevel().orNull(), NutsIsolationLevel.class, arguments, false);
        } else if (apiVersionObj.compareTo("0.8.1") >= 0) {
            fillOption("---init-launchers", null, options.getInitLaunchers().orNull(), true, arguments, false);
            fillOption("---init-platforms", null, options.getInitLaunchers().orNull(), true, arguments, false);
            fillOption("---init-java", null, options.getInitLaunchers().orNull(), true, arguments, false);
            fillOption("---init-scripts", null, options.getInitLaunchers().orNull(), true, arguments, false);
            fillOption("---system-desktop-launcher", null, options.getDesktopLauncher().orNull(), NutsSupportMode.class, arguments, false);
            fillOption("---system-menu-launcher", null, options.getDesktopLauncher().orNull(), NutsSupportMode.class, arguments, false);
            fillOption("---system-custom-launcher", null, options.getDesktopLauncher().orNull(), NutsSupportMode.class, arguments, false);
        }

        fillOption("--name", null, NutsStringUtils.trim(options.getName().orNull()), arguments, false);
