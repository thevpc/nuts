...
public class NutsException extends RuntimeException {
    ...
    public NutsException(NutsSession session, NutsString message) {
        super(message == null ? null : session.getWorkspace().formats().text().nodeFor(message).filteredText());
        this.session = session;
        this.formattedMessage = message == null ? session.getWorkspace().formats().text().blank() : message;
    }
    ...
    public NutsException(NutsSession session, NutsMessage message) {
        super(message == null ? null : session.getWorkspace().formats().text().nodeFor(message).filteredText());
        this.session = session;
        this.formattedMessage = session.getWorkspace().formats().text().nodeFor(message);
    }
    ...
    public NutsException(NutsSession session, NutsMessage message, Throwable cause) {
        super(message == null ? null : session.getWorkspace().formats().text().nodeFor(message).filteredText(), cause);
        this.session = session;
        this.formattedMessage = session.getWorkspace().formats().text().nodeFor(message);
    }
    ...
    public NutsException(NutsSession session, Throwable cause) {
        super(cause);
        this.session = session;
        this.formattedMessage = session.getWorkspace().formats().text().blank();
    }
