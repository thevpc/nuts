...
public interface NPushCommand extends NWorkspaceCommand {
     ...
     * @return {@code this} instance
     */
    NPushCommand removeId(String id);
     ...
     * @return {@code this} instance
     */
    NPushCommand addIds(String... ids);
     ...
     * @return {@code this} instance
     */
    NPushCommand removeLockedId(NId id);
     ...
     * @return {@code this} instance
     */
    NPushCommand addLockedId(NId id);
     ...
     * @return {@code this} instance
     */
    NPushCommand removeLockedId(String id);
     ...
     * @return {@code this} instance
     */
    NPushCommand addLockedId(String id);
     ...
     * @return {@code this} instance
     */
    NPushCommand addLockedIds(NId... values);
     ...
     * @return {@code this} instance
     */
    NPushCommand addLockedIds(String... values);
     ...
     * @return {@code this} instance
     */
    NPushCommand addArg(String arg);
     ...
     * @return {@code this} instance
     */
    NPushCommand addArgs(String... args);
     ...
     * @return {@code this} instance
     */
    NPushCommand args(Collection<String> args);
     ...
     * @return {@code this} instance
     */
    NPushCommand addArgs(Collection<String> args);
     ...
     * @return {@code this} instance
     */
    NPushCommand setOffline(boolean offline);
     ...
     * @return {@code this} instance
     */
    NPushCommand setRepository(String repository);
     ...
     */
    @Override
    NPushCommand setSession(NSession session);
     ...
     */
    @Override
    NPushCommand configure(boolean skipUnsupported, String... args);
