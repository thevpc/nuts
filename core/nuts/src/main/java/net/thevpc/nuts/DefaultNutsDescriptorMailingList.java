...
public class DefaultNutsDescriptorMailingList implements NutsDescriptorMailingList {
    ...
    public DefaultNutsDescriptorMailingList(NutsDescriptorMailingList other) {
    ...
    public DefaultNutsDescriptorMailingList(String id, String name, String subscribe, String unsubscribe, String post, String archive, List<String> otherArchives, Map<String, String> properties, String comments) {
        this.id = id;
        this.name = name;
