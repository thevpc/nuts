...
public class DefaultNValue implements NValue {
    private static NValue NULL = new DefaultNValue(null);

    public static NValue of(Object any) {
        if (any == null) {
            return NULL;
        }
        if (any instanceof NValue) {
            return (NValue) any;
        }
        return new DefaultNValue(any);
    }
    ...
    public DefaultNValue(Object value) {
        this.value = value;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DefaultNValue other = (DefaultNValue) obj;
