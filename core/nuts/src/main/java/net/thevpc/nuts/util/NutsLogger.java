...
public interface NutsLogger {
     ...
     */
    void log(NutsSession session, Level level, NutsLoggerVerb verb, NutsMessage msg, Throwable thrown);
     ...
     */
    void log(NutsSession session, Level level, NutsLoggerVerb verb, Supplier<NutsMessage> msgSupplier, Supplier<Throwable> errorSupplier);
