 ...
 * @since 0.5.5
 */
public interface NFetchDescriptorRepositoryCommand extends NRepositoryCommand {
     ...
     */
    NFetchDescriptorRepositoryCommand setId(NId id);

    @Override
    NFetchDescriptorRepositoryCommand setSession(NSession session);
     ...
     */
    @Override
    NFetchDescriptorRepositoryCommand run();
     ...
     * @return {@code this} instance
     */
    NFetchDescriptorRepositoryCommand setFetchMode(NFetchMode fetchMode);
}
