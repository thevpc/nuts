...
public interface NutsDependencySolver {
    ...
    NutsDependencySolver add(NutsDependency dependency);

    NutsDependencySolver add(NutsDependency dependency, NutsDefinition def);

    NutsDependencySolver setFilter(NutsDependencyFilter dependencyFilter);
