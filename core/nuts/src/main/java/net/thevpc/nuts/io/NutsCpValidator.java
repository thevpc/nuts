 ...
 * @since 0.5.8
 */
public interface NutsCpValidator {

    /**
     * Check the validity of the stream that was copied.
     *
     * @param targetContent targetContent
     * @throws NutsCpValidatorException when no valid
     * @throws IOException                   when I/O error occurs.
     */
    void validate(InputStream targetContent) throws NutsCpValidatorException, IOException;
}
