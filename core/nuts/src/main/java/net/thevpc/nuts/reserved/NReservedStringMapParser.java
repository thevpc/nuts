...
public class NReservedStringMapParser {

    private final String equalsChars;
    private final String separatorChars;
    private final String escapeChars;

    public static NReservedStringMapParser of(String equalsChars, String separatorChars, String escapeChars) {
        return new NReservedStringMapParser(equalsChars, separatorChars, escapeChars);
    }
     ...
     */
    public NReservedStringMapParser(String equalsChars, String separatorChars, String escapeChars) {
