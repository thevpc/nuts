...
public interface NutsCustomCommandManager {
     ...
     */
    boolean updateCommand(NutsCommandConfig command);
     ...
     */
    List<NutsWorkspaceCustomCommand> findCommandsByOwner(NutsId id);
    ...
    void createLauncher(NutsLauncherOptions launcher);
