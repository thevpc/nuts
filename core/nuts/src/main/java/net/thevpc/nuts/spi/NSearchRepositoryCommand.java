 ...
 */
public interface NSearchRepositoryCommand extends NRepositoryCommand {

    NIdFilter getFilter();

    NSearchRepositoryCommand setFilter(NIdFilter filter);

    @Override
    NSearchRepositoryCommand setSession(NSession session);
     ...
     * @return {@code this} instance
     */
    NSearchRepositoryCommand setFetchMode(NFetchMode fetchMode);
