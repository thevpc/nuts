 ...
 * @since 0.5.5
 */
public enum NArgumentType implements NEnum {
    /**
    ...
    public static NOptional<NArgumentType> parse(String value) {
        return NStringUtils.parseEnum(value, NArgumentType.class);
    }
