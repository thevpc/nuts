...
//    }
    ...
    public NColor(byte type, long color, String name) {
        this.type = type;
        this.color = color;
        this.name = name;
    }
    ...
    public static NColor of4(int color) {
        return new NColor(TYPE4, color, null);
    }

    public static NColor of8(int color) {
        return new NColor(TYPE8, color, null);
    }

    public static NColor of24(int color) {
        return new NColor(TYPE24, color, null);
    }

    public static NColor of24(Color color) {
        return new NColor(TYPE24, color.getRGB() & 0xFFFFFF, null);
    }

    public static NColor of32(Color color) {
        return new NColor(TYPE32, color.getRGB(), null);
    }

    public static NColor of32(int r, int g, int b,String name) {
        return new NColor(TYPE32, (r & 255) << 16 | (g & 255) << 8 | (b & 255) << 0, name);
    }

    public static NColor of32(int r, int g, int b) {
        return new NColor(TYPE32, (r & 255) << 16 | (g & 255) << 8 | (b & 255) << 0, null);
    }

    public static NColor of32(int r, int g, int b, int a) {
        return new NColor(TYPE32, (a & 255) << 24 | (r & 255) << 16 | (g & 255) << 8 | (b & 255) << 0, null);
    }
    public static NColor of32(int r, int g, int b, int a,String name) {
        return new NColor(TYPE32, (a & 255) << 24 | (r & 255) << 16 | (g & 255) << 8 | (b & 255) << 0, name);
    }

    public static NColor of64(Color color) {
        return new NColor(TYPE64, color.getRGB(), null);
    }

    public static NColor of32(int color) {
        return new NColor(TYPE32, color, null);
    }

    public static NColor of64(long color) {
        return new NColor(TYPE64, color, null);
    }

    public NColor withName(String name) {
        return new NColor(type, color, name);
    }
