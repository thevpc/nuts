...
public class NSagaContextModel implements Serializable , Cloneable{
    ...
    private NSagaExecutionStatus status;          // RUNNING, FINISHED, FAILED, COMPENSATING
    // optional: timestamps
    ...
    public NSagaExecutionStatus getStatus() {
        return status;
    }

    public NSagaContextModel setStatus(NSagaExecutionStatus status) {
        this.status = status;
        return this;
    }
