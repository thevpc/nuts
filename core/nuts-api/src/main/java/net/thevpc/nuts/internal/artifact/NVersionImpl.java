...
public class NVersionImpl implements NVersion {
        ...
        for (char c : v1.toCharArray()) {
            if (Character.isDigit(c)) {
                ...
                if (last == null) {
                    ...
                    parts.add(new NVersionPartImpl(last.toString(), partType));
                ...
                parts.add(new NVersionPartImpl(String.valueOf(c), NVersionPartType.SEPARATOR));
    ...
    public NVersion toAtMost() {
        ...
        return new NVersionImpl("[" + expression + ",[");
    }
    ...
    public NVersion inc(int index, long amount) {
        return new NVersionImpl(incVersion(value(), index, amount));
    }
    ...
    public boolean equals(Object o) {
        ...
        NVersionImpl version = (NVersionImpl) o;
    ...
    private static class VersionParts {
        ...
        public void setNumberAt(int index, BigInteger value) {
            ...
            for (int i = 0; i < all.size(); i++) {
                ...
                if (s.type() == NVersionPartType.NUMBER) {
                    if (c == index) {
                        all.set(i, new NVersionPartImpl(value.toString(), NVersionPartType.NUMBER));
                        return;
                    }
                    c++;
                }
        ...
        public void setNumberAt(int index, long value) {
            ...
            for (int i = 0; i < all.size(); i++) {
                ...
                if (s.type() == NVersionPartType.NUMBER) {
                    if (c == index) {
                        all.set(i, new NVersionPartImpl(String.valueOf(value), NVersionPartType.NUMBER));
                        return;
                    }
                    c++;
                }
        ...
        public void insertNumber(long val, String sep) {
            if (all.size() == 0) {
                all.add(new NVersionPartImpl(String.valueOf(val), NVersionPartType.NUMBER));
                ...
                all.add(0, new NVersionPartImpl(String.valueOf(val), NVersionPartType.NUMBER));
            } else {
                all.add(0, new NVersionPartImpl(String.valueOf(val), NVersionPartType.NUMBER));
            }
        }
