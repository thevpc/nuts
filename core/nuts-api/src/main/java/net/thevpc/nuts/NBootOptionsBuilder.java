...
public interface NBootOptionsBuilder extends NBootOptions, NComponent {
    ...
    NBootOptionsBuilder setExtensionBootDescriptors(List<NDescriptorBoot> extensionBootDescriptors);
    ...
    NBootOptionsBuilder setRuntimeBootDescriptor(NDescriptorBoot runtimeBootDescriptor);
