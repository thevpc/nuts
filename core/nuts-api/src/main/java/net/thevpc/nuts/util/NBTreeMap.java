...
public class NBTreeMap<K extends Comparable<K>,V> {
    private NBTreeSet<BNodeEntry<K,V>> bt;

    public NBTreeMap(int order) {
        this.bt = new NBTreeSet<>(order);
    }
    ...
    public Set<K> keySet() {
        return new AbstractSet<K>() {
            ...
            public boolean isEmpty() {
                return NBTreeMap.this.isEmpty();
            }

            @Override
            public int size() {
                return NBTreeMap.this.size();
            }
        };
    }
