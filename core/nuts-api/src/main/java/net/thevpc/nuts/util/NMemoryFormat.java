...
public class NMemoryFormat {
    ...
    public static final NMemoryFormat DEFAULT = new NMemoryFormat(null, false).freeze();
    public static final NMemoryFormat IEC = new NMemoryFormat(true, false).freeze();
    public static final NMemoryFormat NON_IEC = new NMemoryFormat(false, false).freeze();
    public static final NMemoryFormat FIXED = new NMemoryFormat(null, true).freeze();
    public static final NMemoryFormat FIXED_IEC = new NMemoryFormat(true, true).freeze();
    public static final NMemoryFormat FIXED_NON_IEC = new NMemoryFormat(false, true).freeze();
