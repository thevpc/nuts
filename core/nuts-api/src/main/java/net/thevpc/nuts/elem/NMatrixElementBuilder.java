...
//
//    NMatrixElementBuilder copyFrom(NElementBuilder other, NAssignmentPolicy assignmentPolicy);
//
//    NMatrixElementBuilder copyFrom(NElement other, NAssignmentPolicy assignmentPolicy);
//}
