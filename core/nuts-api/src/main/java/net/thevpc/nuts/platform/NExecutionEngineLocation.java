 ...
 * @since 0.5.4
 */
public class NExecutionEngineLocation extends NConfigItem implements Cloneable {
    public static final String JAVA_PRODUCT_JDK="jdk";
    public static final String JAVA_PRODUCT_JRE="jre";
    public static final long serialVersionUID = 3;
    private final NId id;
    private final NExecutionEngineFamily executionEngineFamily;
    ...
    public boolean equals(Object o) {
        ...
        NExecutionEngineLocation that = (NExecutionEngineLocation) o;
