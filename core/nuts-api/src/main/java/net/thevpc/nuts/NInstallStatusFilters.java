...
public interface NInstallStatusFilters extends NTypedFilters<NInstallStatusFilter> {
    ...
    NInstallStatusFilter byRequired(boolean value);

    NInstallStatusFilter byDefaultValue(boolean value);

    NInstallStatusFilter byObsolete(boolean value);

    NInstallStatusFilter byDeployed(boolean value);
