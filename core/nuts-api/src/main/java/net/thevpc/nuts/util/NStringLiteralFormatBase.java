...
public abstract class NStringLiteralFormatBase implements NStringLiteralFormat {
    ...
    protected NStringLiteralFormatBase(
     ...
     */
    public static NStringLiteralFormatBase ofEscapeChar(
            NElementType   quoteType,
            NSupportMode   condition,
            NCharEscapeSet charEscapeSet,
            NCharEscape    boundaryEscape) {
     ...
     */
    public static NStringLiteralFormatBase ofPrefix(
            String         linePrefix,
            String         lineSuffix,
            NSupportMode   condition,
            NCharEscapeSet charEscapeSet) {
     ...
     */
    private static final class EscapeCharFormat extends NStringLiteralFormatBase {
     ...
     */
    private static final class RepeatCharFormat extends NStringLiteralFormatBase {
     ...
     */
    private static final class PrefixFormat extends NStringLiteralFormatBase {
