 ...
 */
public class DefaultObservableSet<V> extends AbstractSet<V> implements NObservableSet<V> {

    private Set<V> base = new HashSet<>();
    private List<NObservableSetListener<V>> listeners;

    public DefaultObservableSet(Set<V> base) {
    ...
    public boolean equals(Object o) {
        if (o instanceof DefaultObservableSet) {
            return base.equals(((DefaultObservableSet<?>) o).base);
        }
