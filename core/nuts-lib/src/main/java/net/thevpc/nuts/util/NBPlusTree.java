 ...
 */
public class NBPlusTree<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public static <K extends Comparable<K>, V> NBPlusTree<K, V> of(int m, boolean allowDuplicates) {
        return new NBPlusTree<K, V>(new NBPlusTreeStoreMem<>(m, allowDuplicates));
    }

    public static <K extends Comparable<K>, V> NBPlusTree<K, V> of(int m) {
        return new NBPlusTree<K, V>(new NBPlusTreeStoreMem<>(m, false));
    }
