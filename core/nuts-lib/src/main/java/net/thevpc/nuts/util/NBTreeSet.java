 ...
 */
public class NBTreeSet<T extends Comparable<T>> {
    ...
    private static class TreePrinter {
        ...
        public static <T extends Comparable<T>> String getString(NBTreeSet<T> tree) {
    ...
    public static class JavaCompatibleBTree<T extends Comparable<T>> extends java.util.AbstractCollection<T> {
        ...
        private NBTreeSet<T> tree = null;

        public JavaCompatibleBTree(NBTreeSet<T> tree) {
            this.tree = tree;
        }
        ...
        private static class BTreeIterator<C extends Comparable<C>> implements java.util.Iterator<C> {
            ...
            private NBTreeSet<C> tree = null;
            private NBTreeSet.Node<C> lastNode = null;
            private C lastValue = null;
            private int index = 0;
            private Deque<Node<C>> toVisit = new ArrayDeque<Node<C>>();

            protected BTreeIterator(NBTreeSet<C> tree) {
                this.tree = tree;
            ...
            public C next() {
                ...
                while (toVisit.size()>0) {
                    ...
                    NBTreeSet.Node<C> n = toVisit.pop();
