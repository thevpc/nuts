...
public class NSagaCallBuilderImpl implements NSagaCallBuilder {
    ...
    public NSagaCallBuilderImpl(NSagaCallStore store, NBeanContainer beanContainer) {
        this.store = store;
        this.beanContainer = beanContainer;
    }

    @Override
    public Suite<NSagaCallBuilder> start() {
    ...
    // -------------------------
    private class SuiteImpl<P> implements NSagaCallBuilder.Suite<P> {
        private final P parent;
        private final List<NSagaCallNodeModel> currentNodes;
        private final NSagaCallBuilder builder;

        SuiteImpl(P parent, List<NSagaCallNodeModel> currentNodes, NSagaCallBuilder builder) {
            this.parent = parent;
    ...
    // -------------------------
    private class WhileImpl<P> implements NSagaCallBuilder.While<P> {
        private final P parent;
        private final List<NSagaCallNodeModel> currentNodes;
