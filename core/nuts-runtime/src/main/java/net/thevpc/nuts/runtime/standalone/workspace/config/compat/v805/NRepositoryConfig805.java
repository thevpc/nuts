 ...
 * @since 0.5.4
 */
public class NRepositoryConfig805 extends NConfigItem {
...
//    private String type;
    ...
    public NRepositoryConfig805 setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public NRepositoryConfig805 setUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
...
//    }
    ...
    public NRepositoryConfig805 setLocation(String location) {
    ...
    public NRepositoryConfig805 setStoreLocationStrategy(NStoreStrategy storeLocationStrategy) {
    ...
    public NRepositoryConfig805 setGroups(String groups) {
        this.groups = groups;
        return this;
    }
    ...
    public NRepositoryConfig805 setEnv(Map<String, String> env) {
        this.env = env;
        return this;
    }
    ...
    public NRepositoryConfig805 setMirrors(List<NRepositoryRef> mirrors) {
    ...
    public NRepositoryConfig805 setUsers(List<NUserConfig> users) {
        this.users = users;
        return this;
    }
    ...
    public NRepositoryConfig805 setIndexEnabled(boolean indexEnabled) {
    ...
    public NRepositoryConfig805 setAuthenticationAgent(String authenticationAgent) {
    ...
    public NRepositoryConfig805 setStoreLocations(Map<NStoreType, String> storeLocations) {
...
//        hash = 53 * hash + Objects.hashCode(this.type);
    ...
    public boolean equals(Object obj) {
        ...
        final NRepositoryConfig805 other = (NRepositoryConfig805) obj;
