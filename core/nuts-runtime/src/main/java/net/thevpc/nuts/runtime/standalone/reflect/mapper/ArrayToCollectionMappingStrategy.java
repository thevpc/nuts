...
class ArrayToCollectionMappingStrategy implements NReflectMappingStrategy {
    private final Type to;
    private final Type componentType;

    public ArrayToCollectionMappingStrategy(Type to) {
        this.to = to;
    ...
    public static boolean copyCollection(List<Object> fromObj, Collection<Object> toObj, NReflectMapper context, Type componentType){
        Collection<Object> toColl = (Collection) toObj;
