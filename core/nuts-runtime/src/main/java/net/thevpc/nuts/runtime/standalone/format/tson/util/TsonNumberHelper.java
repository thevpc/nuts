...
//import net.thevpc.nuts.runtime.standalone.format.tson.parser.NumberType;
//
...
//        return real == null ? null : new TsonNumberHelper(real, NumberType.of(real.getClass()), NNumberLayout.DECIMAL, null);
//    }
//
//    public static NElement parseNumber(String s) {
...
//    }
//
//    public TsonNumberHelper(NNumberElement te) {
//        this.unit = te.numberSuffix();
//        this.layout = te.numberLayout();
//        switch (te.type()) {
//            case BIG_COMPLEX: {
//                this.complex = true;
//                NBigComplex bigComplex = te.asBigComplexValue().get();
...
//            case DOUBLE_COMPLEX: {
//                this.complex = true;
//                NDoubleComplex bigComplex = te.asDoubleComplexValue().get();
//                this.real = bigComplex.real();
//                this.imag = bigComplex.imag();
...
//            case FLOAT_COMPLEX: {
//                this.complex = true;
//                NFloatComplex bigComplex = te.asFloatComplexValue().get();
//                this.real = bigComplex.real();
//                this.imag = bigComplex.imag();
...
//            }
//            case BYTE: {
//                this.real = te.asByteValue().get();
//                this.type = NumberType.BYTE;
//                break;
//            }
//            case SHORT: {
//                this.real = te.asShortValue().get();
//                this.type = NumberType.SHORT;
//                break;
//            }
//            case INT: {
//                this.real = te.asIntValue().get();
//                this.type = NumberType.INT;
//                break;
//            }
//            case LONG: {
//                this.real = te.asLongValue().get();
//                this.type = NumberType.LONG;
//                break;
//            }
//            case FLOAT: {
//                this.real = te.asFloatValue().get();
//                this.type = NumberType.FLOAT;
//                break;
//            }
//            case DOUBLE: {
//                this.real = te.asDoubleValue().get();
//                this.type = NumberType.DOUBLE;
//                break;
//            }
//            case BIG_INT: {
...
//    }
//
//    private TsonNumberHelper(Number real, Number imag, NumberType type, NNumberLayout layout, String unit) {
//        this.real = real;
//        this.imag = imag;
...
//    }
//
//    private TsonNumberHelper(Number real, NumberType type, NNumberLayout layout, String unit) {
//        this.real = real;
//        this.complex = false;
//        this.type = type;
//        this.layout = layout;
...
//
//
//    private static NNumberLayout detectRadix(String nbr) {
//        int i = 0;
...
//    }
//
//    private static TsonNumberHelper parseReal(String a, NNumberLayout layout, String unit, NumberType[] numberType) {
//        for (NumberType type : numberType) {
...
//    }
//
//    private static TsonNumberHelper parseReal0(String a, NumberType numberType, NNumberLayout radix, String unit) {
//        try {
//            switch (numberType) {
//                case BYTE: {
...
//        }
//
//        public void parse(NNumberLayout NNumberLayout, NumberType numberType, StrFastReader br) {
//            layout = NNumberLayout;
//            type = numberType;
//            switch (NNumberLayout) {
//                case DECIMAL: {
//                    if (br.read("Min")) {
//                        sb.append("Min");
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.DECIMAL, NumberType.BYTE, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.BINARY, NumberType.BYTE, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.fillTsonNumberHelperValue(Byte.MIN_VALUE);
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.OCTAL, NumberType.BYTE, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.HEXADECIMAL, NumberType.BYTE, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Byte.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.DECIMAL, NumberType.SHORT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.BINARY, NumberType.SHORT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Short.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.OCTAL, NumberType.SHORT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Short.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.HEXADECIMAL, NumberType.SHORT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Short.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.DECIMAL, NumberType.INT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.BINARY, NumberType.INT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Integer.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.OCTAL, NumberType.INT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Integer.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.HEXADECIMAL, NumberType.INT, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Integer.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.DECIMAL, NumberType.LONG, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.BINARY, NumberType.LONG, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Long.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.OCTAL, NumberType.LONG, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Long.MIN_VALUE, n.type, n.layout, n.unit));
...
//                    br.read(2);
//                    n.sb.append(u);
//                    n.parse(NNumberLayout.HEXADECIMAL, NumberType.LONG, br);
//                    if (n.special != null) {
//                        switch (n.special) {
//                            case MIN: {
//                                n.setNh(new TsonNumberHelper(Long.MIN_VALUE, n.type, n.layout, n.unit));
...
//        if (br.read("0x")) {
//            n.sb.append("0x");
//            n.layout = NNumberLayout.HEXADECIMAL;
//            n.type = NumberType.INT;
//            if (br.read("Min")) {
//                n.sb.append("Min");
...
//            n.sb.append(n.unit);
//        }
//        n.layout = NNumberLayout.DECIMAL;
//        if (!n.decimal) {
//            if (n.suffix != null) {
...
//                case INT:
//                case FLOAT:
//                    return NElement.ofFloatComplex(
//                            getReal().floatValue(),
//                            getImag().floatValue(),
//                            getUnit());
//                case LONG:
//                case DOUBLE:
//                    return NElement.ofDoubleComplex(
//                            getReal().doubleValue(),
//                            getImag().doubleValue(), getUnit());
//                case BIG_INTEGER:
//                    return NElement.ofBigComplex(
...
//            switch (getType()) {
//                case BYTE:
//                    return NElement.ofByte(getReal().byteValue(), getRadix(), getUnit());
//                case SHORT:
//                    return NElement.ofShort(getReal().shortValue(), getRadix(), getUnit());
//                case INT:
//                    return NElement.ofInt(getReal().intValue(), getRadix(), getUnit());
//                case LONG:
//                    return NElement.ofLong(getReal().longValue(), getRadix(), getUnit());
//                case FLOAT:
//                    return NElement.ofFloat(getReal().floatValue(), getUnit());
//                case DOUBLE:
//                    return NElement.ofDouble(getReal().floatValue(), getUnit());
//                case BIG_INTEGER:
//                    return NElement.ofBigInt((BigInteger) getReal(), getRadix(), getUnit());
//                case BIG_DECIMAL:
//                    return NElement.ofBigDecimal((BigDecimal) getReal(), getUnit());
//            }
//        }
