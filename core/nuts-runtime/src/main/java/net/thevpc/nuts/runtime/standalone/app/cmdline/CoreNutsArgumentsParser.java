...
//                .registerSpecialSimpleOption("-version", session);
...
//                String k = a.getKey().getString().get(session);
//                switch (k) {
//                    //**********************************
//                    //*
...
//                        if (active && a.getBooleanValue().orElse(false)) {
...
//                                    v = "false";
//                                } else {
//                                    v = "" + (!NutsUtilStrings.parseBoolean(v).orElse(false));
//                                }
//                            }
//                            if (v.isEmpty()) {
...
//                                if (a.isNegated()) {
//                                    options.setDebug(
//                                            String.valueOf(!NutsUtilStrings.parseBoolean(a.getStringValue())
...
//                    case "-T":
//                        if (active) {
//                            options.addOutputFormatOptions(cmdLine.nextStringValue().get(session));
//                        } else {
//                            cmdLine.skip();
//                        }
//                        break;
...
//                    throw new NutsIllegalArgumentException(session, NMsg.formatted(errorMessage.toString()));
//                } else {
...
//                a = cmdLine.nextString().get(session);
//                if (enabled) {
//                    logConfig.setLogFileCount(a.getValue().getInt().get(session));
//                }
//                break;
//            }
//
...
//                cmdLine.skip();
//                if (enabled) {
//                    String id = a.getKey().getString().get(session);
//                    logConfig.setLogFileLevel(NutsUtilStrings.parseLogLevel(id.substring("--log-file-".length())).ifEmpty(null).get(session));
//                }
//                break;
//            }
//
...
//                            NutsUtilStrings.parseLogLevel(id.substring("--log-term-".length())).ifEmpty(null).get(session)
//                            );
//                }
//                break;
//            }
...
//            case "--verbose": {
//                cmdLine.skip();
//                if (enabled && a.getBooleanValue().get(session)) {
...
//                if (enabled) {
//                    String id = a.getKey().getString().get(session);
//                    Level lvl = NutsUtilStrings.parseLogLevel(id.substring("--log-".length())).ifEmpty(null).get(session);
