...
public class InternalNRepositoryFilterRPI extends InternalNTypedFilters<NRepositoryFilter>
        implements NRepositoryFilterRPI {

    public InternalNRepositoryFilterRPI() {
