 ...
 * @author vpc
 */
public class FigletCharSimple implements FigletChar {

    private char[][] map;

    public FigletCharSimple(char[][] map) {
        this.map = map;
    }

    @Override
    public NText getRow(int l) {
        char[] a = map[l];
        return a == null ? null : NText.ofPlain(new String(a));
    }
