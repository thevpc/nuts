 ...
 * @author vpc
 */
public class FigletNTextArtTextRenderer implements NTextArtTextRenderer, Cloneable {
    ...
    public static NOptional<FigletNTextArtTextRenderer> ofName(String name) {
        try {
            URL u = Thread.currentThread().getContextClassLoader().getResource("META-INF/textart/figlet/" + name + ".flf");
            if (u != null) {
        ...
        try {
            URL u = FigletNTextArtTextRenderer.class.getClassLoader().getResource("META-INF/textart/figlet/" + name + ".flf");
            if (u != null) {
                return NOptional.of(new FigletNTextArtTextRenderer(NPath.of(u)));
            }
        } catch (Exception ex) {
    ...
    public String toString() {
        return "FigletNTextArtTextRenderer(" + fontName + ')';
    }
}
