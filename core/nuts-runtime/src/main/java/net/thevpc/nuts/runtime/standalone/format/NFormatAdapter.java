 ...
 * @author thevpc
 */
public abstract class NFormatAdapter /*extends DefaultFormatBase<NFormat>*/ implements NFormat {

    protected List<String[]> confCmds = new ArrayList<>();
    protected boolean ntf;

    public abstract NFormatAndValue<Object, NFormat> getBase(Object aValue);

    public NFormatAndValue<Object, NFormat> getConfBase(Object aValue) {
        NFormatAndValue<Object, NFormat> b = getBase(aValue);
    ...
    @Override
    public NFormat setNtf(boolean ntf) {
        this.ntf = ntf;
        return this;
    }
    ...
    @Override
    public NFormat configure(boolean skipUnsupported, String... args) {
        confCmds.add(args);
        return this;
    }
