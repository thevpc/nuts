...
public class DefaultElementMapperStore {
    ...
    public static final NElementMapper F_NUTS_SDK_LOCATION = new NElementMapperNRuntimeDistribution();
...
//        addDefaultMapper(NText.class, new NElementMapperNString());
        ...
        addCoreMapper(NRuntimeDistribution.class, F_NUTS_SDK_LOCATION);
