 ...
 * @author thevpc
 */
class DefaultNCharStreamElement extends AbstractNElement implements NCharStreamElement {

    private final NReaderProvider value;

    DefaultNCharStreamElement(NReaderProvider value, NElementAnnotation[] annotations, NElementComments comments) {
