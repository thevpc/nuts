...
public class DefaultTableObjectWriter extends DefaultObjectWriterBase<NTableWriter> implements NTableWriter {
...
//            resolveColumns(o, columns);
    ...
    public boolean configureFirst(NCmdLine cmdLine) {
        ...
        if ((a = cmdLine.nextFlag("--no-header").orNull()) != null) {
            ...
            if (a.isUncommented()) {
                helper.setBorder(a.literalValue().asString().orElse(""));
            }
            return true;
