...
public class TextNodeWriterContext {
    private boolean filtered;
    private boolean numberTitles;
    private TextNumberSeq seq;

    public static void main(String[] args) {
        TextNumberSeq n=new DefaultTextNumberSeq("a1");
        System.out.println(n=n.newLevel(0));
        System.out.println(n=n.newLevel(1));
        System.out.println(n=n.newLevel(2));
        System.out.println(n=n.newLevel(1));
        System.out.println(n=n.newLevel(1));
        System.out.println(n=n.newLevel(0));
    ...
    public TextNodeWriterContext setNumberTitles(boolean numberTitles) {
        this.numberTitles = numberTitles;
        return this;
    }

    public TextNumberSeq getSeq() {
        return seq;
    }

    public TextNodeWriterContext setSeq(TextNumberSeq seq) {
        this.seq = seq;
        return this;
    }
    ...
    public TextNodeWriterContext setFiltered(boolean filtered) {
        this.filtered = filtered;
        return this;
    }

    interface TextNumberSeq{
        TextNumber[] getPattern();
        TextNumberSeq newLevel(int level);
        TextNumber[] getValue();
        String getString(String delimiter);
//        TextNumberSeq setValue(TextNumber[] newValue);
    }

    public static class DefaultTextNumberSeq implements TextNumberSeq{
        private TextNumber[] value;

        public DefaultTextNumberSeq(String pattern) {
        ...
        public DefaultTextNumberSeq(TextNumber ... pattern) {
        ...
        public TextNumberSeq newLevel(int level) {
            level=level-1;
            if(level<=0){
...
//        @Override
        public TextNumberSeq setValue(TextNumber[] newValue) {
            return new DefaultTextNumberSeq(newValue);
        }
