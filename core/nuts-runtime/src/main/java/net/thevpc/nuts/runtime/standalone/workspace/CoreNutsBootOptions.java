...
//
//    public CoreNutsBootOptions(DefaultNutsWorkspaceBootOptionsBuilder boot, NutsWorkspace ws, NutsSession session) {
//        this.ws = ws;
//        this.session = session;
//        DefaultNutsWorkspaceOptionsBuilder optionsBuilder = new DefaultNutsWorkspaceOptionsBuilder(session);
