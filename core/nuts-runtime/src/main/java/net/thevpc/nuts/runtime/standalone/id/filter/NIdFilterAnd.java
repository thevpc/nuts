...
public class NIdFilterAnd extends AbstractIdFilter implements NIdFilter, NSimplifiable<NIdFilter>, NExprIdFilter, NComplexExpressionString {

    private NIdFilter[] children;

    public NIdFilterAnd(NSession session, NIdFilter... all) {
    ...
    public NIdFilter simplify() {
        return CoreFilterUtils.simplifyFilterAnd(getSession(), NIdFilter.class,this,children);
    }
    ...
    public String toString() {
        return CoreStringUtils.trueOrAnd(Arrays.stream(children).map(NComplexExpressionString::toString).collect(Collectors.toList()));
    }
    ...
    public boolean equals(Object obj) {
        ...
        final NIdFilterAnd other = (NIdFilterAnd) obj;
