...
import net.thevpc.nuts.util.NBTreeSet;
 ...
 */
public class NBTreeSetImpl<T extends Comparable<T>> implements NBTreeSet<T> {
    ...
    private static class Node<T extends Comparable<T>> {
        ...
        private Comparator<Node<T>> comparator = new Comparator<NBTreeSetImpl.Node<T>>() {
            @Override
            public int compare(NBTreeSetImpl.Node<T> arg0, NBTreeSetImpl.Node<T> arg1) {
    ...
    private static class TreePrinter {
        ...
        public static <T extends Comparable<T>> String getString(NBTreeSetImpl<T> tree) {
    ...
    public static class JavaCompatibleBTree<T extends Comparable<T>> extends java.util.AbstractCollection<T> {
        ...
        private NBTreeSetImpl<T> tree = null;

        public JavaCompatibleBTree(NBTreeSetImpl<T> tree) {
            this.tree = tree;
        }
        ...
        private static class BTreeIterator<C extends Comparable<C>> implements java.util.Iterator<C> {
            ...
            private NBTreeSetImpl<C> tree = null;
            private NBTreeSetImpl.Node<C> lastNode = null;
            private C lastValue = null;
            private int index = 0;
            private Deque<Node<C>> toVisit = new ArrayDeque<Node<C>>();

            protected BTreeIterator(NBTreeSetImpl<C> tree) {
                this.tree = tree;
            ...
            public C next() {
                ...
                while (toVisit.size()>0) {
                    ...
                    NBTreeSetImpl.Node<C> n = toVisit.pop();
