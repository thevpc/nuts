...
public class NTextPropertiesTheme implements NTextTheme {
    private final Properties props = new Properties();
    private final NWorkspace workspace;

    public NTextPropertiesTheme(String name, ClassLoader cls, NWorkspace workspace) {
    ...
    public NTextStyles toBasicStyles(NTextStyle style, boolean basicTrueStyles, int maxLoop) {
        ...
        if (s == null) {
            switch (style.type()){
                case FORE_COLOR:{
                    //basicTrue is true!!
                    return NTextStyles.of(NTextStyle.foregroundTrueColor(DefaultNTextTheme.foregroundSimpleToTrueColor(style.variant())));
                }
                case BACK_COLOR:{
                    //basicTrue is true!!
                    return NTextStyles.of(NTextStyle.foregroundTrueColor(DefaultNTextTheme.backgroundSimpleToTrueColor(style.variant())));
                }
            }
            return NTextStyles.PLAIN;
        }
    ...
    public NTextStyles toBasicStyles(String v, boolean basicTrueStyles, int defaultVariant, int maxLoop) {
        ...
        switch (st) {
            ...
            case FORE_COLOR: {
                ...
                if (basicTrueStyles) {
                    return toBasicStyles(NTextStyles.of(NTextStyle.foregroundTrueColor(DefaultNTextTheme.foregroundSimpleToTrueColor(ii))), basicTrueStyles);
                }
            }
            case BACK_COLOR: {
                NColor c = getVarValAsColor(n);
                ...
                if (basicTrueStyles) {
                    return toBasicStyles(NTextStyles.of(NTextStyle.backgroundTrueColor(DefaultNTextTheme.backgroundSimpleToTrueColor(ii))), basicTrueStyles);
                }
            }
