 ...
 * @author vpc
 */
public class DefaultNutsElementFormatHelper {
    ...
    public DefaultNutsElementFormatHelper(NutsWorkspace ws) {
        this.ws = ws;
    ...
    public NutsElementStreamFormat getJsonMan() {
        return jsonMan;
    }

    public NutsElementStreamFormat getYamlMan() {
        return yamlMan;
    }

    public NutsElementStreamFormat getXmlMan() {
        return xmlMan;
    }
