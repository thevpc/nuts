 ...
 */
public class NDescriptorFilterDesktopEnvironment extends AbstractDescriptorFilter  {
    ...
    public NDescriptorFilter simplify() {
        if (NBlankable.isBlank(desktopEnvironment)) {
            return null;
        }
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final NDescriptorFilterDesktopEnvironment other = (NDescriptorFilterDesktopEnvironment) obj;
