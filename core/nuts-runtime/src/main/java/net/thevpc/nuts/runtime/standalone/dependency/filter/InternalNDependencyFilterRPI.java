...
public class InternalNDependencyFilterRPI extends InternalNTypedFilters<NDependencyFilter>
        implements NDependencyFilterRPI {

    public InternalNDependencyFilterRPI() {
