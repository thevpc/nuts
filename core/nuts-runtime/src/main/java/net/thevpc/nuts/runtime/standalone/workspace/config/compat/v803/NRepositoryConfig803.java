 ...
 * @since 0.5.4
 */
public class NRepositoryConfig803 extends NConfigItem {
...
//    private String type;
    ...
    public NRepositoryConfig803 setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public NRepositoryConfig803 setUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
...
//    }
    ...
    public NRepositoryConfig803 setLocation(String location) {
    ...
    public NRepositoryConfig803 setStoreLocationStrategy(NStoreLocationStrategy storeLocationStrategy) {
    ...
    public NRepositoryConfig803 setGroups(String groups) {
        this.groups = groups;
        return this;
    }
    ...
    public NRepositoryConfig803 setEnv(Map<String, String> env) {
        this.env = env;
        return this;
    }
    ...
    public NRepositoryConfig803 setMirrors(List<NRepositoryRef> mirrors) {
    ...
    public NRepositoryConfig803 setUsers(List<NUserConfig> users) {
        this.users = users;
        return this;
    }
    ...
    public NRepositoryConfig803 setIndexEnabled(boolean indexEnabled) {
    ...
    public NRepositoryConfig803 setAuthenticationAgent(String authenticationAgent) {
    ...
    public NRepositoryConfig803 setStoreLocations(Map<NStoreLocation, String> storeLocations) {
...
//        hash = 53 * hash + Objects.hashCode(this.type);
    ...
    public boolean equals(Object obj) {
        ...
        final NRepositoryConfig803 other = (NRepositoryConfig803) obj;
