 ...
 * @author thevpc
 */
class DefaultNBinaryStreamElement extends AbstractNElement implements NBinaryStreamElement {

    private final NInputStreamProvider value;

    DefaultNBinaryStreamElement(NInputStreamProvider value, NElementAnnotation[] annotations, NElementComments comments) {
    ...
    public boolean equals(Object obj) {
        ...
        final DefaultNBinaryStreamElement other = (DefaultNBinaryStreamElement) obj;
