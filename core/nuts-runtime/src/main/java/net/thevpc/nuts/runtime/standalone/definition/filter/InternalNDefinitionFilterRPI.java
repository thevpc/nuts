...
public class InternalNDefinitionFilterRPI extends InternalNTypedFilters<NDefinitionFilter>
        implements NDefinitionFilterRPI {


    public InternalNDefinitionFilterRPI() {
