...
public class MethodReflectProperty3 extends AbstractReflectProperty {
    ...
    public MethodReflectProperty3(String name, Field read, Method write, Object cleanInstance, NutsReflectType type, NutsReflectPropertyDefaultValueStrategy defaultValueStrategy) {
        this.read = read;
