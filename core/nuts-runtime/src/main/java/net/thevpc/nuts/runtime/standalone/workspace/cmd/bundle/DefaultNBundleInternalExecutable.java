    ...
    private void createAppScripts(NId mainIdStr, NId nutsId, NPath bundleFolder,
        ...
        for (NOsFamily osFamily : new NOsFamily[]{NOsFamily.UNIX, NOsFamily.LINUX, NOsFamily.MACOS, NOsFamily.WINDOWS}) {
            ...
            out
                    ...
                    .setDisableCommands(!options.embedded).printlnSetAppendVar("NS_WS_OPTIONS", " --embedded")
                    .setDisableCommands().printlnSetAppendVar("NS_WS_OPTIONS", " -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005")
                    .printlnComment("")
