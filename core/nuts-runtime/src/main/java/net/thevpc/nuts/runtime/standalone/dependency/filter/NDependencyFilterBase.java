 ...
 * @author thevpc
 */
public abstract class NDependencyFilterBase extends NFilterBase implements NDependencyFilter, NSimplifiable<NDependencyFilter> {

    public NDependencyFilterBase(NFilterOp op) {
        super(op);
    }
