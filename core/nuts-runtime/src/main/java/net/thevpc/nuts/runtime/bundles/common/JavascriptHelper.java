...
//                NutsIdFilter f = NutsIdFilters.of(session).byExpression(pattern);
//                return f.acceptId((NutsId) value, session);
//            }
//            if (value instanceof NutsDependency) {
//                NutsDependencyFilter f = NutsDependencyFilters.of(session).byExpression(pattern);
...
//                NutsVersionFilter f = NutsVersionFilters.of(session).byExpression(pattern);
