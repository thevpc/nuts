...
public class NutsRepositoryConfig507 extends NutsConfigItem {
    ...
    public NutsRepositoryConfig507() {
    }
    ...
    public NutsRepositoryConfig507 setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public NutsRepositoryConfig507 setUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
    ...
    public NutsRepositoryConfig507 setLocation(String location) {
    ...
    public NutsRepositoryConfig507 setStoreLocationStrategy(NutsStoreLocationStrategy storeLocationStrategy) {
    ...
    public NutsRepositoryConfig507 setGroups(String groups) {
        this.groups = groups;
        return this;
    }
    ...
    public NutsRepositoryConfig507 setEnv(Map<String, String> env) {
        this.env = env;
        return this;
    }
    ...
    public NutsRepositoryConfig507 setMirrors(List<NutsRepositoryRef> mirrors) {
    ...
    public NutsRepositoryConfig507 setUsers(List<NutsUserConfig> users) {
        this.users = users;
        return this;
    }
    ...
    public NutsRepositoryConfig507 setIndexEnabled(boolean indexEnabled) {
    ...
    public NutsRepositoryConfig507 setAuthenticationAgent(String authenticationAgent) {
    ...
    public NutsRepositoryConfig507 setStoreLocations(Map<NutsStoreLocation, String> storeLocations) {
    ...
    public boolean equals(Object obj) {
        ...
        final NutsRepositoryConfig507 other = (NutsRepositoryConfig507) obj;
