...
import net.thevpc.nuts.util.NBTreeMap;
import net.thevpc.nuts.util.NBTreeSet;

import java.util.*;

public class NBTreeMapImpl<K extends Comparable<K>,V> implements NBTreeMap<K,V> {
    private NBTreeSet<BNodeEntry<K,V>> bt;

    public NBTreeMapImpl(int order) {
        this.bt = new NBTreeSetImpl<>(order);
    }
    ...
    public Set<K> keySet() {
        return new AbstractSet<K>() {
            ...
            public boolean isEmpty() {
                return NBTreeMapImpl.this.isEmpty();
            }

            @Override
            public int size() {
                return NBTreeMapImpl.this.size();
            }
        };
    }
