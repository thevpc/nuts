...
import net.thevpc.nuts.command.NUpdate;
...
public abstract class AbstractNUpdate extends NWorkspaceCmdBase<NUpdate> implements NUpdate {
    ...
    @Override
    public NUpdate addId(String id) {
        return addId(id == null ? null : NId.get(id).get());
    }

    @Override
    public NUpdate addId(NId id) {
        if (id == null) {
    ...
    @Override
    public NUpdate addIds(String... ids) {
        for (String id : ids) {
            addId(id);
        }
        return this;
    ...
    @Override
    public NUpdate removeId(NId id) {
        if (id != null) {
            this.ids.remove(id);
        }
        return this;
    ...
    @Override
    public NUpdate removeId(String id) {
    ...
    @Override
    public NUpdate setOptional(boolean includeOptional) {
    ...
    @Override
    public NUpdate addArg(String arg) {
        if (arg != null) {
            if (this.args == null) {
    ...
    @Override
    public NUpdate clearArgs() {
        this.args = null;
        return this;
    }

    @Override
    public NUpdate addArgs(String... args) {
        return addArgs(args == null ? null : Arrays.asList(args));
    }

    @Override
    public NUpdate addArgs(Collection<String> args) {
        if (this.args == null) {
            this.args = new ArrayList<>();
        }
        if (args != null) {
    ...
    @Override
    public NUpdate checkUpdates(boolean applyUpdates) {
        checkUpdates();
        if (applyUpdates) {
            update();
        }
...
//    }
    ...
    @Override
    public NUpdate clearIds() {
        this.ids.clear();
        return this;
    }

    @Override
    public NUpdate addLockedId(NId id) {
        if (id != null) {
            lockedIds.add(id);
        }
        return this;
    ...
    @Override
    public NUpdate addLockedId(String id) {
    ...
    @Override
    public NUpdate addLockedIds(NId... ids) {
        if (ids != null) {
            for (NId id : ids) {
                addId(id);
            }
    ...
    @Override
    public NUpdate addLockedIds(String... ids) {
        if (ids != null) {
            for (String id : ids) {
                addId(id);
            }
    ...
    @Override
    public NUpdate clearLockedIds() {
        this.lockedIds.clear();
        return this;
    }

    @Override
    public NUpdate clearScopes() {
        this.scopes.clear();
        return this;
    }
