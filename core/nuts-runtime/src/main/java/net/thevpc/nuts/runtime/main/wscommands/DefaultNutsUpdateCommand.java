...
import net.thevpc.nuts.runtime.wscommands.AbstractNutsUpdateCommand;
import net.thevpc.nuts.runtime.DefaultNutsUpdateResult;
import net.thevpc.nuts.runtime.DefaultNutsWorkspaceUpdateResult;
...
//    }
    ...
    private void applyResult(NutsWorkspaceUpdateResult result) {
        ...
        boolean accept = ws.io().term().getTerminal().ask()
                ...
                .setSession(getSession()).getValue();
...
//        NutsSession sessionOffline = session.copy().setFetchMode(NutsFetchMode.OFFLINE);
        ...
        DefaultNutsUpdateResult defaultNutsUpdateResult = new DefaultNutsUpdateResult(id, oldFile, newFile,
                newFile == null ? null : Arrays.stream(newFile.getDependencies()).map(NutsDependency::toId).toArray(NutsId[]::new),
                false);
