...
public class DefaultNTreeObjectWriter extends DefaultObjectWriterBase<NTreeObjectWriter> implements NTreeObjectWriter {

    private DefaultNTextArtTreeRenderer renderer = new DefaultNTextArtTreeRenderer("default");
    private NText rootName;


    public DefaultNTreeObjectWriter() {
        this( null, null);
    }
    ...
    private XNodeFormatter xNodeFormatter = new XNodeFormatter() {
        ...
        public NText[] getMultilineArray(NText key, Object value) {
            return DefaultNTreeObjectWriter.this.getMultilineArray(key, value);
        }
