...
public interface NutsElementFactoryService {
    ...
    Object createObject(NutsElement o, Type to, NutsElementFactoryContext context);

    Object defaultCreateObject(NutsElement o, Type to, NutsElementFactoryContext context);
