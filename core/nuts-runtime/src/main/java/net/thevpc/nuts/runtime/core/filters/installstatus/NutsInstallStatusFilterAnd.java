...
public class NutsInstallStatusFilterAnd extends AbstractNutsFilter implements NutsInstallStatusFilter, Simplifiable<NutsInstallStatusFilter> {

    private NutsInstallStatusFilter[] all;

    public NutsInstallStatusFilterAnd(NutsWorkspace ws, NutsInstallStatusFilter... all) {
