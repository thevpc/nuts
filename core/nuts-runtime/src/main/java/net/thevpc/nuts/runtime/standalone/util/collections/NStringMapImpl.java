...
public class NStringMapImpl<V> implements NStringMap<V> {
    private Map<String, V> map;
    private char separator;

    public NStringMapImpl(Map<String, V> map, char separator) {
    ...
    public NStringMapImpl<V> removeAll(String prefix) {
        NAssert.requireNamedNonNull(prefix, "prefix");
        if (prefix.isEmpty()) {
            return this;
        }
    ...
    public NStringMapImpl<V> putAll(Map<String, V> values) {
    ...
    public NStringMapImpl<V> putAll(String prefix, Map<String, V> values) {
        NAssert.requireNamedNonNull(prefix, "prefix");
        NAssert.requireNamedNonNull(values, "values");
    ...
    public NStringMapImpl<V> copy() {
        return new NStringMapImpl<>(new LinkedHashMap<>(map), separator);
    }
}
