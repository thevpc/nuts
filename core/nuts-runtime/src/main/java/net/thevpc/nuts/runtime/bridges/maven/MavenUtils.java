...
import net.thevpc.nuts.runtime.bridges.maven.mvnutil.ArchetypeCatalogParser;
...
import net.thevpc.nuts.runtime.bridges.maven.mvnutil.Pom;
import net.thevpc.nuts.runtime.bridges.maven.mvnutil.PomDependency;
import net.thevpc.nuts.runtime.bridges.maven.mvnutil.PomId;
import net.thevpc.nuts.runtime.bridges.maven.mvnutil.PomIdFilter;
import net.thevpc.nuts.runtime.bridges.maven.mvnutil.PomXmlParser;
