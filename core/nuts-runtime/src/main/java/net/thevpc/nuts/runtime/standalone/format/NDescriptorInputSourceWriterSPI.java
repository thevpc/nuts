...
public class NDescriptorInputSourceWriterSPI implements NObjectWriterSPI {
    private DefaultNDigest.NDescriptorInputSource value;

    public NDescriptorInputSourceWriterSPI(DefaultNDigest.NDescriptorInputSource value) {
        this.value = value;
    }
