 ...
 */
public class NDefinitionFilterPlatform extends DefinitionFilterBase {
    ...
    public boolean acceptDefinition(NDefinition descriptor) {
        return CoreFilterUtils.matchesPlatform(platform, descriptor.descriptor().condition().platform());
    }
    ...
    public boolean equals(Object o) {
        ...
        NDefinitionFilterPlatform that = (NDefinitionFilterPlatform) o;
