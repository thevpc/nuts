...
import net.thevpc.nuts.runtime.standalone.wscommands.deploy.DefaultNutsDeployInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.fetch.DefaultNutsFetchInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.help.DefaultNutsHelpInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.info.DefaultNutsInfoInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.install.DefaultNutsInstallInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.install.DefaultNutsReinstallInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.license.DefaultNutsLicenseInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.push.DefaultNutsPushInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.search.DefaultNutsSearchInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.settings.DefaultNutsAliasExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.settings.DefaultNutsSettingsInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.undeploy.DefaultNutsUndeployInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.uninstall.DefaultNutsUninstallInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.update.DefaultNutsCheckUpdatesInternalExecutable;
import net.thevpc.nuts.runtime.standalone.wscommands.update.DefaultNutsUpdateInternalExecutable;
