 ...
 * @author thevpc
 */
public abstract class NRepositoryFilterBase extends NFilterBase implements NRepositoryFilter, NSimplifiable<NRepositoryFilter> {

    public NRepositoryFilterBase(NFilterOp op) {
        super(op);
    }
