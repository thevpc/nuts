 ...
 * @author thevpc
 */
public class NIterableStream<T> extends AbstractNStream<T> {

    private final NIterable<T> o;

    public NIterableStream(NSession session, String nutsBase, NIterable<T> o) {
    ...
    public boolean equals(Object obj) {
        ...
        final NIterableStream<?> other = (NIterableStream<?>) obj;
