...
public class DefaultNFragmentElementBuilder extends AbstractNElementBuilder implements NFragmentElementBuilder {
    ...
    @Override
    public NFragmentElementBuilder addAffixAt(int index, NBoundAffix affix) {
    ...
    @Override
    public NFragmentElementBuilder setAffixAt(int index, NBoundAffix affix) {
    ...
    @Override
    public NFragmentElementBuilder setAffixAt(int index, NAffix affix, NAffixAnchor anchor) {
