 ...
 */
public class NDefaultObservableMap<K, V> extends AbstractMap<K, V> implements NObservableMap<K, V> {

    private Map<K, V> base;
    private List<NObservableMapListener<K, V>> listeners;


    public NDefaultObservableMap(Map<K, V> base) {
        this.base = base==null?new HashMap<>():base;
    }

    public NDefaultObservableMap() {
