...
//
//public class NutsOutputTargetImpl implements NutsOutputTarget{
//    private final Object value;
//    private final Type type;
//    private final boolean disposable;
//    private final NutsSession session;
//
//    private NutsOutputTargetImpl(Object value, Type type, boolean disposable, NutsSession session) {
//        this.value = value;
//        this.type = type;
...
//    }
//
//    public static NutsOutputTarget ofSpecial(Object value, Type type, NutsSession session) {
//        return new NutsOutputTargetImpl(value, type, false, session);
//    }
//
//    public static NutsOutputTarget ofDisposable(NutsPath value) {
//        return new NutsOutputTargetImpl(value, Type.PATH, true, value.getSession());
//    }
//
//    public static NutsOutputTarget of(File value, NutsSession session) {
//        return of(NutsPath.of(value, session));
//    }
//
//    public static NutsOutputTarget of(URL value, NutsSession session) {
//        return of(NutsPath.of(value, session));
//    }
//
//    public static NutsOutputTarget of(Path value, NutsSession session) {
//        return of(NutsPath.of(value, session));
//    }
//
//    public static NutsOutputTarget of(String value, NutsSession session) {
//        return of(NutsPath.of(value, session));
//    }
//
//    public static NutsOutputTarget of(NutsOutputTarget value) {
//        return value;
//    }
//
//    public static NutsOutputTarget of(NutsPrintStream value) {
//        return new NutsOutputTargetImpl(value, Type.NUTS_PRINT_STREAM, false, value.getSession());
//    }
//
//    public static NutsOutputTarget ofAnyOutputOrErr(Object value, NutsSession session) {
//        NutsOutputTarget a = ofAnyOutputOrNull(value, session);
//        if (a != null) {
//            return a;
//        }
...
//    }
//
//    public static NutsOutputTarget ofAnyInputOrErr(Object value, NutsSession session) {
//        NutsOutputTarget a = ofAnyInputOrNull(value, session);
//        if (a != null) {
//            return a;
//        }
...
//    }
//
//    public static NutsOutputTarget ofAnyOutputOrNull(Object value, NutsSession session) {
//        if (value == null) {
//            return null;
//        }
...
//    }
//
//    public static NutsOutputTarget ofAnyInputOrNull(Object value, NutsSession session) {
//        if (value == null) {
//            return null;
//        }
//        if (value instanceof byte[]) {
...
//    }
//
//    public static NutsOutputTarget of(InputStream value, NutsSession session) {
//        return new NutsOutputTargetImpl(value, Type.INPUT_STREAM, false, session);
//    }
//
//    public static NutsOutputTarget of(OutputStream value, NutsSession session) {
//        return new NutsOutputTargetImpl(value, Type.OUTPUT_STREAM, false, session);
//    }
//
...
//    }
//
//    public NutsOutputTarget toMultiRead(NutsSession session) {
//        if (value instanceof NutsPath) {
//            return this;
//        }
...
//    }
//
//    public NutsOutputTarget toDisposable(NutsSession session) {
//        String name = getName();
...
//        switch (type) {
//            case PATH:
//                return getPath().toCompressedForm().getOutputMetaData();
//            case INPUT_STREAM:
//            case OUTPUT_STREAM: {
...
//        }
//        if (value instanceof InputStream) {
//            return NutsIO.of(session).createInputSource((InputStream) value).getInputMetaData().getName();
//        }
...
//    }
//
//    public NutsOutputTargetImpl[] list() {
//        if (isPath()) {
//            NutsPath p = getPath();
//            return p.list().map(NutsFunction.of(NutsOutputTargetImpl::of, "NutsStreamOrPath::of"))
//                    .toArray(NutsOutputTargetImpl[]::new);
//        }
//        return new NutsOutputTargetImpl[0];
//    }
//
//    public Type getType() {
//        return type;
...
//    }
//
//    public NutsOutputTarget setKindType(String s) {
//        if (isPath()) {
//            return of(getPath().setUserKind(s));
//        } else if (isInputStream()) {
//            NutsInputSourceMetadata md = getStreamMetaData();
//            md.setUserKind(s);
//            return this;
//        }
//        return this;
