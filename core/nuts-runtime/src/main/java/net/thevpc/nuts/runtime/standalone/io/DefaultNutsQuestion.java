    ...
    private T execute() {
        ...
        while (true) {
            ...
            if (this.getDefaultValue() != null) {
                ...
                out.printf("default is %s", ws.text().forStyled(ff.format(this.getDefaultValue(), this), NutsTextStyle.primary(1)));
            }
            if (getHintMessage() != null) {
                ...
                if (_acceptedValues.length > 0) {
                    ...
                    out.printf("accepts %s", ws.text().forStyled(sb.toString(), NutsTextStyle.primary(4)));
                }
                if (!first) {
                    out.print(")");
                }
