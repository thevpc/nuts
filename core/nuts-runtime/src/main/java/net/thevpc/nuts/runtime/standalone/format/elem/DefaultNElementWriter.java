...
//            }
    ...
    @Override
    public NElementWriter setIndestructibleFormat() {
        return setIndestructibleObjects(CoreNElementUtils.DEFAULT_INDESTRUCTIBLE_FORMAT);
    }

    public NElementWriter setIndestructibleObjects(Predicate<Class<?>> destructTypeFilter) {
        this.indestructibleObjects = destructTypeFilter;
        return this;
    }

    private NElementStreamFormat resolveStructuredFormat() {
        if (contentType == null || contentType == NContentType.PLAIN) {
    ...
    private DefaultNElementFactoryContext createFactoryContext() {
        ...
        DefaultNElementFactoryContext c = new DefaultNElementFactoryContext(ntf, reflectRepository, userElementMapperStore, indestructibleObjects);
