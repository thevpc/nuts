...
public final class NWorkspaceCmdLineParserBoot {

    /**
     * private constructor
     */
    private NWorkspaceCmdLineParserBoot() {
    }

    public static List<NArgBoot> nextNutsArgument(NCmdLineBoot cmdLine, NBootOptionsBoot options) {
        while (cmdLine.hasNext()) {
            NArgBoot a = cmdLine.peek();
            if (a.isOption()) {
                ...
                switch (k) {
                    ...
                    case "--workspace": {
                        ...
                        if (active && options != null) {
                            String file = NUtilsBoot.firstNonNull(a.getStringValue(), "");
                    ...
                    case "-u": {
                        a = cmdLine.nextEntry();
                        if (active && options != null) {
                            String v = NUtilsBoot.firstNonNull(a.getStringValue(), "");
                    ...
                    case "--boot-runtime": {
                        a = cmdLine.nextEntry();
                        if (active && options != null) {
                            String br = NUtilsBoot.firstNonNull(a.getStringValue(), "");
                            if (br.indexOf('#') >= 0) {
                                //this is a full id
                                options.setRuntimeId(br);
                            } else {
                                NIdBoot r = NIdBoot.ofRuntime(br);
                    ...
                    case "--boot-java-home": {
                        ...
                        if (active && options != null) {
                            String v = a.getStringValue();
                            options.setJavaCommand(NReservedUtilsBoot.resolveJavaCommand(v));
                        }
                        return (Collections.singletonList(a));
                    }
                    case "--java-options":
                    ...
                    case "--system-run-home": {
                        ...
                        if (active && options != null) {
                            options.setHomeLocation(NHomeLocationBoot.of(null, folder), v);
                        }
                        return (Collections.singletonList(a));
                    }
                    ...
                    case "--unix-run-home": {
                        ...
                        if (active && options != null) {
                            options.setHomeLocation(NHomeLocationBoot.of(layout, folder), v);
                        }
                        return (Collections.singletonList(a));
                    ...
                    case "--switch": {
                        a = cmdLine.nextFlag();
                        if (active && options != null) {
                            options.setSwitchWorkspace(NUtilsBoot.firstNonNull(a.getBooleanValue(), true));
                        }
                        return (Collections.singletonList(a));
                    }
                        ...
                        if (active) {
                            if (options != null) {
                                if (a.isFlagOption()) {
                                    ...
                                    String v = NUtilsBoot.firstNonNull(parseTerminalMode(a.getStringValue()), "FORMATTED");
                                    if (NUtilsBoot.sameEnum(v, "DEFAULT")) {
                                        v = "INHERITED";
                                    }
                    ...
                    case "--debug": {
                        ...
                        if (active) {
                            if (options != null) {
                                if (NStringUtilsBoot.isBlank(a.getStringValue())) {
                                    options.setDebug(String.valueOf(a.isEnabled()));
                                } else {
                                    if (a.isNegated()) {
                                        options.setDebug(String.valueOf(!NUtilsBoot.parseBoolean(a.getStringValue(), true, false)));
                                    } else {
                    ...
                    case "--log-file-count": {
                        if (active) {
                            NLogConfigBoot logConfig = options.getLogConfig();
                            if (logConfig == null) {
                                logConfig = new NLogConfigBoot();
                            }
                            NArgBoot r = parseLogLevel(logConfig, cmdLine, active);
                    ...
                    case "--output-format":
                        ...
                        if (active) {
                            if (options != null) {
                                String t = NUtilsBoot.firstNonNull(a.getStringValue(), "");
                                int i = NReservedLangUtilsBoot.firstIndexOf(t, new char[]{' ', ';', ':', '='});
                                if (i > 0) {
                    ...
                    case "--tson":
                        ...
                        if (active) {
                            if (options != null) {
                                ...
                                options.addOutputFormatOptions(NUtilsBoot.firstNonNull(a.getStringValue(), ""));
                            }
                            return (Collections.singletonList(a));
                        } else {
                            return (Collections.singletonList(a));
                        ...
                        if (active) {
                            ...
                            if (options != null) {
                                if (a.getValue() != null) {
                                    ...
                                    showError.add(NMsgBoot.ofC("invalid argument for workspace: %s", a.getImage()).toString());
                            ...
                            return (newArgs.stream().map(NArgBoot::of).collect(Collectors.toList()));
                        } else {
                    ...
                    case "--expire": {
                        ...
                        if (active) {
                            if (options != null) {
                                if (!NStringUtilsBoot.isBlank(a.getStringValue())) {
                                    options.setExpireTime(NUtilsBoot.parseInstant(a.getValue()));
                                } else {
                                ...
                                while ((a = cmdLine.next()) != null) {
                                    if (a.isOption()) {
                                        if (options != null) {
                                            ...
                                            executorOptions.add(NUtilsBoot.firstNonNull(a.getImage(), ""));
                                            newArgs.add(NUtilsBoot.firstNonNull(a.getImage(), ""));
                                        ...
                                        if (options != null) {
                                            ...
                                            applicationArguments.add(NUtilsBoot.firstNonNull(a.toString(), ""));
                    ...
                    default: {
                        if (k.startsWith("---") && k.length() > 3 && k.charAt(3) != '-') {
                            ...
                            if (options != null) {
                                ...
                                showError.add(NMsgBoot.ofC("nuts: invalid option %s", a.getImage()).toString());
                            }
                            NArgBoot finalA1 = a;
                            throw new NBootException(NMsgBoot.ofC("unsupported option %s", finalA1));
                        }
                    }
                }
            } else {
        ...
        throw new NBootException(NMsgBoot.ofC("unsupported %s", cmdLine.peek()));
    }


    public static void parseNutsArguments(String[] bootArguments, NBootOptionsBoot options) {
        NCmdLineBoot cmdLine = new NCmdLineBoot(bootArguments)
                .setCommandName("nuts")
        ...
        if (!(options.getApplicationArguments().size() > 0
                ...
                || NUtilsBoot.firstNonNull(options.getCommandHelp(), false)
                || options.getApplicationArguments().get(0).equals("version")
                || NUtilsBoot.firstNonNull(options.getCommandVersion(), false)))) {
            if (!options.getErrors().isEmpty()) {
                ...
                if (!NUtilsBoot.firstNonNull(options.getSkipErrors(), false)) {
                    throw new NBootException(NMsgBoot.ofPlain(errorMessage.toString()));
                }
            }
        }
    }

    private static NArgBoot parseLogLevel(NLogConfigBoot logConfig, NCmdLineBoot cmdLine, boolean enabled) {
        NArgBoot a = cmdLine.peek();
        switch (a.key()) {
            case "--log-file-size": {
                a = cmdLine.nextEntry();
                String v = a.getStringValue();
                if (enabled) {
                    Integer fileSize = NReservedLangUtilsBoot.parseFileSizeInBytes(v, 1024 * 1024);
                    if (fileSize == null) {
                        if (NStringUtilsBoot.isBlank(v)) {
                            throw new NBootException(NMsgBoot.ofC("invalid file size : %s", v));
                        }
                    } else {
                        //always in mega
                        fileSize = fileSize / (1024 * 1024);
                        if (fileSize <= 0) {
                            throw new NBootException(NMsgBoot.ofC("invalid file size : %s < 1Mb", v));
                        }
                    }
                    if (fileSize != null) {
            ...
            case "--log-file-count": {
                a = cmdLine.nextEntry();
                if (enabled) {
                    logConfig.setLogFileCount(NUtilsBoot.firstNonNull(NUtilsBoot.parseInt(a.getValue()), 0));
                    return (a);
                } else {
                    return (a);
                }
            ...
            case "--verbose": {
                cmdLine.skip();
                if (enabled && NUtilsBoot.firstNonNull(a.getBooleanValue(), true)) {
    ...
    private static String parseStoreStrategy(String s) {
        switch (NUtilsBoot.enumName(NUtilsBoot.firstNonNull(NStringUtilsBoot.trim(s), ""))) {
            case "EXPLODED":
            case "E":
                return "EXPLODED";
            case "STANDALONE":
        ...
        throw new NBootException(NMsgBoot.ofC("unable to parse value for NStoreStrategy : %s", s));
    }
    ...
    private static String parseFetchStrategy(String s) {
        ...
        throw new NBootException(NMsgBoot.ofC("unable to parse value for NFetchStrategy : %s", s));
    }
    ...
    private static String parseSupportMode(String s) {
        ...
        throw new NBootException(NMsgBoot.ofC("unable to parse value for NutsStoreStrategy : %s", s));
    }
    ...
    private static String parseStoreType(String s) {
        ...
        throw new NBootException(NMsgBoot.ofC("unable to parse value for NStoreType : %s", s));
    }
    ...
    private static String parseOsFamily(String s) {
        String e = NUtilsBoot.enumName(NUtilsBoot.firstNonNull(NStringUtilsBoot.trim(s), ""));
        switch (e) {
            case "WINDOWS":
            case "W":
                return "WINDOWS";
    ...
    private static String parseNutsOpenMode(String s) {
        ...
        throw new NBootException(NMsgBoot.ofC("unable to parse value for NutsOpenMode : %s", s));
    }
