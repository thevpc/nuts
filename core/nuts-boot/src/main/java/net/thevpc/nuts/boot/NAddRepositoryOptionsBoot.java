 ...
 * @since 0.5.4
 */
public class NAddRepositoryOptionsBoot implements Serializable, Cloneable {
     ...
     */
    private NRepositoryConfigBoot config;
     ...
     * default constructor
     */
    public NAddRepositoryOptionsBoot() {
    }
     ...
     * @param other other
     */
    public NAddRepositoryOptionsBoot(NAddRepositoryOptionsBoot other) {
    ...
    public NAddRepositoryOptionsBoot copy() {
        return clone();
    }

    @Override
    protected NAddRepositoryOptionsBoot clone() {
        try {
            NAddRepositoryOptionsBoot o = (NAddRepositoryOptionsBoot) super.clone();
     ...
     */
    public NAddRepositoryOptionsBoot setOrder(int order) {
        this.order = order;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setTemporary(boolean value) {
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setName(String value) {
        this.name = value;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setLocation(String value) {
        this.location = value;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setEnabled(boolean value) {
        this.enabled = value;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setFailSafe(boolean value) {
        this.failSafe = value;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setCreate(boolean value) {
        this.create = value;
        return this;
    }
     ...
     */
    public NRepositoryConfigBoot getConfig() {
        return config;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setConfig(NRepositoryConfigBoot value) {
        this.config = value;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public NAddRepositoryOptionsBoot setDeployWeight(int value) {
    ...
    public boolean equals(Object o) {
        ...
        NAddRepositoryOptionsBoot that = (NAddRepositoryOptionsBoot) o;
