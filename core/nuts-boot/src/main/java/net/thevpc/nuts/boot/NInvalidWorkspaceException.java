 ...
 * @since 0.5.4
 */
public class NInvalidWorkspaceException extends NBootException {
     ...
     */
    public NInvalidWorkspaceException(String workspaceLocation, NMsgBoot errorMessage) {
        super(
                NMsgBoot.ofC("invalid workspace %s : %s", (workspaceLocation == null ? "<null>" : workspaceLocation), errorMessage)
                , null);
