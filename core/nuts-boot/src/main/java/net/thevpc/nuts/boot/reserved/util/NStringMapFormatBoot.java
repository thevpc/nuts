...
public class NStringMapFormatBoot {
    public static NStringMapFormatBoot URL_FORMAT = NStringMapFormatBoot.of("=", "&", "\\", true);
    public static NStringMapFormatBoot COMMA_FORMAT = NStringMapFormatBoot.of("=", ",", "\\", true);
    public static NStringMapFormatBoot DEFAULT = URL_FORMAT;
    ...
    public static NStringMapFormatBoot of(String equalsChars, String separatorChars, String escapeChars, boolean sort) {
        return new NStringMapFormatBoot(equalsChars, separatorChars, escapeChars, sort);
    }

    public NStringMapFormatBoot copy(String equalsChars, String separatorChars, String escapeChars, Boolean sort) {
        return new NStringMapFormatBoot(
                equalsChars==null?this.equalsChars:equalsChars,
                separatorChars==null?this.separatorChars:separatorChars,
                escapeChars==null?this.escapeChars:escapeChars,
     ...
     */
    public NStringMapFormatBoot(String equalsChars, String separatorChars, String escapeChars, boolean sort) {
        this.sort = sort;
        if (equalsChars != null) {
...
//                        cr = (char) r;
    ...
    public Map<String, String> parse(String text) {
        Map<String, List<String>> d = parseDuplicates(text);
    ...
    public Map<String, List<String>> parseDuplicates(String text) {
        ...
        if (NStringUtilsBoot.isBlank(text)) {
            return m;
        }
        ...
        while (true) {
            ...
            try {
                ...
                throw new NBootException(NMsgBoot.ofPlain("failed to read token"));
            }
            if (r != null) {
                tokens.add(r);
            } else {
    ...
    public String formatDuplicates(Map<String, List<String>> map) {
            ...
            for (String k : sortedKeys) {
                ...
                for (String v : strings) {
                    if (v != null) {
                        ...
                        if (v.isEmpty()) {
                            sb.append(
                                    NStringUtilsBoot.formatStringLiteral(k, NQuoteTypeBoot.SIMPLE, NSupportModeBoot.PREFERRED, escapedChars)
                            );
                        } else {
                            sb.append(
                                            NStringUtilsBoot.formatStringLiteral(k, NQuoteTypeBoot.SIMPLE, NSupportModeBoot.PREFERRED, escapedChars))
                                    .append(equalsChars)
                                    .append(NStringUtilsBoot.formatStringLiteral(v, NQuoteTypeBoot.SIMPLE, NSupportModeBoot.PREFERRED, escapedChars)
                                    );
                        }
                    } else {
                        if (sb.length() > 0) {
        ...
        return NStringUtilsBoot.trimToNull(sb.toString());
    }
    ...
    public boolean equals(Object o) {
        ...
        NStringMapFormatBoot that = (NStringMapFormatBoot) o;
