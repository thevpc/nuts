 ...
 * @author thevpc
 */
public class NWorkspaceOptionsConfigBoot {
    ...
    public NWorkspaceOptionsConfigBoot setApiVersion(String apiVersion) {
    ...
    public NWorkspaceOptionsConfigBoot setCompact(boolean compact) {
        if (compact) {
            shortOptions = true;
    ...
    public boolean equals(Object o) {
        ...
        NWorkspaceOptionsConfigBoot that = (NWorkspaceOptionsConfigBoot) o;
