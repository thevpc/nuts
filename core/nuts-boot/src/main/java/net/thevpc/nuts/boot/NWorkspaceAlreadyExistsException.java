 ...
 * @since 0.5.4
 */
public class NWorkspaceAlreadyExistsException extends NBootException {
    ...
    public NWorkspaceAlreadyExistsException(String workspaceLocation) {
        super(NMsgBoot.ofC("workspace already exists %s", (workspaceLocation == null ? "<null>" : workspaceLocation)), null);
    ...
    public NWorkspaceAlreadyExistsException(String workspaceLocation, Throwable err) {
        super(NMsgBoot.ofC("workspace already exists %s", (workspaceLocation == null ? "<null>" : workspaceLocation)), err);
        this.workspaceLocation = workspaceLocation;
    }
