...
public class NDurationBoot implements Serializable {
    private long nanos;
    private long micros;
    ...
    public NDurationBoot(long[] values, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
    ...
    public NDurationBoot(long timeMillis, int timeNanos) {
    ...
    public NDurationBoot(long timeMillis, int timeNanos, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        this.timeMillis = timeMillis;
        this.timeNanos = timeNanos;
    ...
    public static NDurationBoot ofNanos(long durationNanos) {
        long ms = durationNanos / 1000000;
        int ns = (int) (durationNanos % 1000000);
        return new NDurationBoot(ms, ns);
    }

    public static NDurationBoot ofNanos(long durationNanos, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        long ms = durationNanos / 1000000;
        int ns = (int) (durationNanos % 1000000);
        return new NDurationBoot(ms, ns, smallestUnit, largestUnit);
    }

    public static NDurationBoot ofNanosOnly(long durationNanos) {
        return ofUnitOnly(durationNanos, ChronoUnit.MILLIS);
    }

    public static NDurationBoot ofMillisOnly(long durationMillis) {
        return ofUnitOnly(durationMillis, ChronoUnit.MILLIS);
    }

    public static NDurationBoot ofSecondsOnly(long durationSeconds) {
        return ofUnitOnly(durationSeconds, ChronoUnit.SECONDS);
    }

    public static NDurationBoot ofMinutesOnly(long durationMinutes) {
        return ofUnitOnly(durationMinutes, ChronoUnit.MINUTES);
    }

    public static NDurationBoot ofHoursOnly(long durationHours) {
        return ofUnitOnly(durationHours, ChronoUnit.HOURS);
    }

    public static NDurationBoot ofDaysOnly(long durationDays) {
        return ofUnitOnly(durationDays, ChronoUnit.DAYS);
    }

    public static NDurationBoot ofWeeksOnly(long durationWeeks) {
        return ofUnitOnly(durationWeeks, ChronoUnit.WEEKS);
    }

    public static NDurationBoot ofMonthOnly(long durationMonths) {
        return ofUnitOnly(durationMonths, ChronoUnit.MONTHS);
    }

    public static NDurationBoot ofYearsOnly(long durationYears) {
        return ofUnitOnly(durationYears, ChronoUnit.YEARS);
    }

    public static NDurationBoot ofSeconds(long durationSeconds) {
        return ofUnit(durationSeconds, ChronoUnit.SECONDS);
    }

    public static NDurationBoot ofMinutes(long durationMinutes) {
        return ofUnit(durationMinutes, ChronoUnit.MINUTES);
    }

    public static NDurationBoot ofHours(long durationHours) {
        return ofUnit(durationHours, ChronoUnit.HOURS);
    }

    public static NDurationBoot ofDays(long durationDays) {
        return ofUnit(durationDays, ChronoUnit.DAYS);
    }

    public static NDurationBoot ofWeeks(long durationWeeks) {
        return ofUnit(durationWeeks, ChronoUnit.WEEKS);
    }

    public static NDurationBoot ofMonth(long durationMonths) {
        return ofUnit(durationMonths, ChronoUnit.MONTHS);
    }

    public static NDurationBoot ofYears(long durationYears) {
        return ofUnit(durationYears, ChronoUnit.YEARS);
    }

    public static NDurationBoot ofUnitOnly(long durationInUnit, ChronoUnit unit) {
        long[] values = new long[ChronoUnit.values().length];
        values[unit.ordinal()] = durationInUnit;
        return new NDurationBoot(values, null, null);
    }

    public static NDurationBoot ofUnit(long durationInUnit, ChronoUnit unit) {
        return ofUnitOnly(durationInUnit, unit).normalize();
    }

    public static NDurationBoot ofMillis(long durationMillis) {
        return new NDurationBoot(durationMillis, 0);
    }

    public static NDurationBoot ofMillis(long durationMillis, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        return new NDurationBoot(durationMillis, 0, smallestUnit, largestUnit);
    }

    public static NDurationBoot ofDuration(Duration duration) {
    ...
    public static NDurationBoot ofMillisAndNanos(long durationMillis, int nanos) {
        return new NDurationBoot(durationMillis, nanos);
    }

    public static NDurationBoot of(long[] values, ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        return new NDurationBoot(values, smallestUnit, largestUnit);
    }

    public static NDurationBoot of(long[] values) {
        return of(values, null, null);
    }

    public static NDurationBoot ofSecondsAndNanos(long durationSeconds, long nanos) {
    ...
    public NDurationBoot withSmallestUnit(ChronoUnit smallestUnit) {
        NDurationBoot d = new NDurationBoot(toUnitsArray(), smallestUnit, largestUnit);
    ...
    public NDurationBoot withLargestUnit(ChronoUnit largestUnit) {
        NDurationBoot d = new NDurationBoot(toUnitsArray(), smallestUnit, largestUnit);
        if (this.timeMillis != d.timeMillis || this.timeNanos != d.timeNanos) {
            throw new IllegalArgumentException("unexpected");
        }
    ...
    public NDurationBoot withUnits(ChronoUnit smallestUnit, ChronoUnit largestUnit) {
        NDurationBoot d = new NDurationBoot(toUnitsArray(), smallestUnit, largestUnit);
        if (this.timeMillis != d.timeMillis || this.timeNanos != d.timeNanos) {
            throw new IllegalArgumentException("unexpected");
        }
    ...
    public NDurationBoot add(NDurationBoot other) {
        long[] a = toUnitsArray();
    ...
    public NDurationBoot mul(double other) {
    ...
    public NDurationBoot mul(long other) {
        long[] a = toUnitsArray();
        for (int i = 0; i < a.length; i++) {
            a[i] *= other;
        }
    ...
    public NDurationBoot subtract(NDurationBoot other) {
        long[] a = toUnitsArray();
        long[] b = other.toUnitsArray();
        for (int i = 0; i < a.length; i++) {
            a[i] -= b[i];
    ...
    public NDurationBoot normalize() {
        ...
        NDurationBoot d = new NDurationBoot(values, smallestUnit, largestUnit);
        if (this.timeMillis != d.timeMillis || this.timeNanos != d.timeNanos) {
            throw new IllegalArgumentException("unexpected");
        }
        return d;
