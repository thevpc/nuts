...
public class NReservedErrorInfo {
    private final NIdBoot nutsId;
    private final String repository;
    private final String url;
    private final String message;
    private final Throwable throwable;

    public NReservedErrorInfo(NIdBoot nutsId, String repository, String url, String message, Throwable throwable) {
        this.nutsId = nutsId;
    ...
    public String toString() {
        ...
        if(!NStringUtilsBoot.isBlank(getMessage())){
