 ...
 * @since 0.5.4
 */
public class NLogConfigBoot implements Serializable, Cloneable {
    private static final long serialVersionUID = 1;
    public static NLogConfigBoot BLANK=new NLogConfigBoot().readOnly();
    ...
    public NLogConfigBoot() {
    }

    public NLogConfigBoot(NLogConfigBoot other, boolean readOnly) {
    ...
    public NLogConfigBoot setLogFileFilter(Filter logFileFilter) {
        if(readOnly){
    ...
    public NLogConfigBoot setLogTermFilter(Filter logTermFilter) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
    ...
    public NLogConfigBoot setLogFileLevel(Level logFileLevel) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
    ...
    public NLogConfigBoot setLogTermLevel(Level logTermLevel) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
     ...
     */
    public NLogConfigBoot setLogFileSize(int logFileSize) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
     ...
     * @return {@code this} instance
     */
    public NLogConfigBoot setLogFileCount(int logFileCount) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
     ...
     * @return {@code this} instance
     */
    public NLogConfigBoot setLogFileName(String logFileName) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
     ...
     * @return {@code this} instance
     */
    public NLogConfigBoot setLogFileBase(String logFileBase) {
        if(readOnly){
            throw new IllegalArgumentException("read only");
        }
    ...
    public NLogConfigBoot copy() {
        return new NLogConfigBoot(this,false);
    }

    public NLogConfigBoot readOnly() {
        if(readOnly) {
            return this;
        }
        return new NLogConfigBoot(this,true);
    }
    ...
    public boolean equals(Object o) {
        ...
        NLogConfigBoot that = (NLogConfigBoot) o;
