...
//        }
    ...
    public void open(boolean autoCreate) throws IOException {
        ...
        boolean found = false;
        if (file.exists()) {
            NutsRepositoryConfig newConfig = JsonUtils.loadJson(file, NutsRepositoryConfig.class);
            if (newConfig != null) {
                found = true;
        ...
        if (!found) {
            if (autoCreate) {
                NutsRepositoryConfig newConfig = new NutsRepositoryConfig(getRepositoryId(), config.getLocation(), config.getType());
                checkNutsRepositoryConfig(newConfig);
                config = newConfig;
            } else {
    ...
    protected int getSupportLevel(NutsId id) {
        ...
        return id.getGroup().matches(StringUtils.simpexpToRegexp(groups, false)) ? groups.length() : 0;
    }
    ...
    public void save() throws IOException {
        ...
        File file = IOUtils.createFile(getRoot(), NutsConstants.NUTS_REPOSITORY_FILE);
        ...
        if (created) {
            log.log(Level.INFO, StringUtils.alignLeft(getRepositoryId(), 20) + " Created repository " + getRepositoryId() + " at " + getRoot().getPath());
        } else {
            log.log(Level.FINE, StringUtils.alignLeft(getRepositoryId(), 20) + " Updated repository " + getRepositoryId() + " at " + getRoot().getPath());
        }
...
//        mirors.remove(repo);
    ...
    public NutsRepository addMirror(String repositoryId, String location, String type, boolean autoCreate) throws IOException {
        ...
        NutsRepositoryConfig newConf = new NutsRepositoryConfig(repositoryId, location, type);
    ...
    public String toString() {
        return "id=" + getRepositoryId() + " ; impl=" + getClass().getSimpleName() + " ; folder=" + getRoot() + (StringUtils.isEmpty(config.getLocation()) ? "" : (" ; location=" + config.getLocation()));
    }
    ...
    public void setUserCredentials(String username, String credentials) throws IOException {
        if (StringUtils.isEmpty(credentials)) {
            ...
            credentials = SecurityUtils.httpEncrypt(credentials.getBytes(), NutsConstants.DEFAULT_PASSPHRASE);
        }
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Update user credentials " + username);
    ...
    public NutsDescriptor fetchDescriptor(NutsId id, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Fetch desc " + id);
    ...
    public String fetchHash(NutsId id, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Fetch component hash " + id);
    ...
    public String fetchDescriptorHash(NutsId id, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Fetch desc hash " + id);
    ...
    public NutsId deploy(NutsId id, NutsDescriptor descriptor, File file, NutsSession session) throws IOException {
        ...
        id = id.unsetQuery();
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Deploy " + id);
    ...
    public void push(NutsId id, String repoId, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Push " + id);
    ...
    public Iterator<NutsId> find(final NutsDescriptorFilter filter, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Find components");
    ...
    public NutsId resolveId(NutsId id, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Resolve " + id);
    ...
    public NutsFile fetch(NutsId id, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Fetch component " + id);
    ...
    public boolean fetchDescriptor(NutsId id, NutsSession session, File localPath) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Fetch desc (to local) " + id);
    ...
    public Iterator<NutsId> findVersions(NutsId id, NutsVersionFilter versionFilter, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Fetch versions for " + id);
    ...
    public void undeploy(NutsId id, NutsSession session) throws IOException {
        ...
        log.log(Level.FINEST, StringUtils.alignLeft(getRepositoryId(), 20) + " Undeploy " + id);
