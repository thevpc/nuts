...
//            }
    ...
    static abstract class AbstractPlatformBeanProperty implements PlatformBeanProperty {
    ...
    static class DefaultPlatformBeanProperty extends AbstractPlatformBeanProperty {
