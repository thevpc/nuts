...
public interface NutsInstallerComponent extends NutsComponent<NutsFile> {
    ...
    default boolean isInstalled(NutsFile nutToInstall, NutsWorkspace workspace, NutsSession session) throws IOException {
        ...
        NutsExecutionContext executionContext = new NutsExecutionContext(nutToInstall, new String[0], installer == null ? null : installer.getArgs(), installer == null ? null : installer.getProperties(), session, workspace);
