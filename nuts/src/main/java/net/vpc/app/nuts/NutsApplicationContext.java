...
public interface NutsApplicationContext extends NutsCommandLineContext, NutsConfigurable {
     ...
     * @return Auto complete instance associated with the {@link NutsApplicationMode#AUTO_COMPLETE} mode
     */
    @Override
     ...
     * @return path to the variable files (aka /var in POSIX systems) folder of this application
     */
    Path getVarFolder();

    /**
     * path to the libraries files (non applications) folder of this application
     * @return path to the libraries files (non applications) folder of this application
     */
    Path getLibFolder();
