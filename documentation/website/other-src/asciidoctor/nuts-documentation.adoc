...
ls : nuts alias (owner maven-local://net.thevpc.app.nuts.toolbox:nsh#0.8.7.0 ) : maven-local://net.thevpc.app.nuts.toolbox:nsh#0.8.7.0 -c ls
...
nuts-api-version         = 0.8.8
nuts-api-id              = net.thevpc.app.nuts:nuts#0.8.8
nuts-runtime-id          = net.thevpc.app.nuts:nuts-core#0.8.7.0
nuts-runtime-path        = ~/.cache/nuts/default-workspace/boot/net/vpc/app/nuts/nuts-core/0.8.7.0/nuts-core-0.8.7.0.jar;~/.cache/nuts/default-workspace/boot/net/vpc/app/nuts/nuts/0.8.8/nuts-0.8.8.jar;~/.cache/nuts/default-workspace/boot/com/google/code/gson/gson/2.8.5/gson-2.8.5.jar;~/.cache/nuts/default-workspace/boot/org/fusesource/jansi/jansi/1.17.1/jansi-1.17.1.jar
...
java-classpath           = ~/.m2/repository/net/vpc/app/nuts/nuts/0.8.8/nuts-0.8.8.jar
...
IcX 2019-08-24 11:05:49.591 admin     maven-local      net.thevpc.app.nuts.toolbox:nsh#0.8.7.0
...
Here the **version** command show api version (0.8.8) and the impl version (0.8.7.0)
=== Welcome Command
...
nuts net.thevpc.nsh:nsh#0.8.7.0
...
cd /workspace
wget https://maven.thevpc.net/net/thevpc/nuts/nuts-app/0.8.8/nuts-app-0.8.8.jar -qO nuts.jar
...
$ curl -sL https://maven.thevpc.net/net/thevpc/nuts/nuts-app/0.8.8/nuts-app-0.8.8.jar -o nuts.jar
$ java -jar nuts.jar -Zy
$ exit
...
download [nuts-app-0.8.8.jar](https://maven.thevpc.net/net/thevpc/nuts/nuts-app/0.8.8/nuts-app-0.8.8.jar)


[source]
----

java -jar nuts-app-0.8.8.jar -r=+preview -Zy
