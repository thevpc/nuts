...
ls : nuts alias (owner maven-local://net.thevpc.app.nuts.toolbox:nsh#0.8.9.0 ) : maven-local://net.thevpc.app.nuts.toolbox:nsh#0.8.9.0 -c ls
...
nuts-api-version         = 0.8.9
nuts-api-id              = net.thevpc.app.nuts:nuts#0.8.9
nuts-runtime-id          = net.thevpc.app.nuts:nuts-core#0.8.9.0
nuts-runtime-path        = ~/.cache/nuts/default-workspace/boot/net/vpc/app/nuts/nuts-core/0.8.9.0/nuts-core-0.8.9.0.jar;~/.cache/nuts/default-workspace/boot/net/vpc/app/nuts/nuts/0.8.9/nuts-0.8.9.jar;~/.cache/nuts/default-workspace/boot/com/google/code/gson/gson/2.8.5/gson-2.8.5.jar;~/.cache/nuts/default-workspace/boot/org/fusesource/jansi/jansi/1.17.1/jansi-1.17.1.jar
...
java-classpath           = ~/.m2/repository/net/vpc/app/nuts/nuts/0.8.9/nuts-0.8.9.jar
...
IcX 2019-08-24 11:05:49.591 admin     maven-local      net.thevpc.app.nuts.toolbox:nsh#0.8.9.0
...
Here the **version** command show api version (0.8.9) and the impl version (0.8.9.0)
=== Welcome Command
...
nuts net.thevpc.nsh:nsh#0.8.9.0
...
public class App {
    ...
    @NAppUninstall // this method is not required, implement when needed
    public void onUninstallApplication() {
        s.out().printf("we are uninstalling My Application : %s%n", s.getAppId());
    }

    @NAppUpdate // this method is not required, implement when needed
...
cd /workspace
wget https://maven.thevpc.net/net/thevpc/nuts/nuts-app/0.8.9/nuts-app-0.8.9.jar -qO nuts.jar
...
$ curl -sL https://maven.thevpc.net/net/thevpc/nuts/nuts-app/0.8.9/nuts-app-0.8.9.jar -o nuts.jar
$ java -jar nuts.jar -Zy
$ exit
...
download [nuts-app-0.8.9.jar](https://maven.thevpc.net/net/thevpc/nuts/nuts-app/0.8.9/nuts-app-0.8.9.jar)


[source]
----

java -jar nuts-app-0.8.9.jar -r=+preview -Zy
