---
title: HTTP Web Client (NHttpClient)
---
...
- **Stateful Cookie & Header Management** – Attach global cookies and base URIs to the client instance (`NHttpClient`)[cite: 7], or override them granularly on a per-request layer (`NHttpRequest`)[cite: 8].
