...
- CHANGED: When generating latest jar, it will support natively thevpc.net
- ADDED: added option --preview-repo | -U to help simplifying latest mode installation. 
...
- CHANGED: for now on, nuts jar will include information about if it supports automatically latest features. You still can disable them using repo filters.  
