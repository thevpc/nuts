...
Version 0.8.9 is a major milestone in our development cycle. 
As part of our commitment to quality, we treat our odd-numbered releases (5, 7, 9) as our most stable and polished versions.
...
* **Runtimes:** JDK/JRE (```sh nuts settings add java --download -version=25 --jdk```)
