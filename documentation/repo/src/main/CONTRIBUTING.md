...
* working on existing issues. The issues are marked with labels. The priority is given always to the current version milestone (example {{apiVersion}}).
...
* **[installers]**    : contains GUI installers.
...
* **[scripts]**        : useful scripts for development and release, you should add them to your path (includes as an example `nuts-dev`)
