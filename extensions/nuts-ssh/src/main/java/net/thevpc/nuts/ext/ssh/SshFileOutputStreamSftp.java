...
public class SshFileOutputStreamSftp extends OutputStream {
    ...
    public SshFileOutputStreamSftp(NConnectionString path, boolean mkdirs, boolean closeConnection) {
    ...
    public SshFileOutputStreamSftp(SshConnection connection, String remotePath, boolean mkdirs, boolean closeConnection) {
