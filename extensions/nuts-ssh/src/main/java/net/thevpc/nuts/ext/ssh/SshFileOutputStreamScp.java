...
public class SshFileOutputStreamScp extends OutputStream {
    private NPath temp;
    private NConnectionString path;
    private boolean mkdirs;
    private OutputStream tempOS;

    public SshFileOutputStreamScp(NConnectionString path, boolean mkdirs) {
        super();
        this.path = path;
        this.mkdirs = mkdirs;
    ...
    public void close() throws IOException {
        ...
        try (SshConnection connection = SshConnectionPool.of().acquire(path)) {
            JCshSShConnection c = (JCshSShConnection)((SshConnectionAdapter)connection).connection;
