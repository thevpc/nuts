...
public class JCshFileInputStreamScp extends DynamicInputStream {
    ...
    public JCshFileInputStreamScp(NConnectionString path) {
        ...
        this.connection = (JCshConnection)SshConnectionPool.of().acquire(path);
    }

    JCshFileInputStreamScp(JCshConnection connection, String path, boolean closeConnection) {
        super(4096);
        this.from = path;
        init = false;
        filesize = 0L;
