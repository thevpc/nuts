...
@NUnused
public class SshFileOutputStreamScpOld extends OutputStream {
    ...
    public SshFileOutputStreamScpOld(NConnectionString path, boolean mkdirs, boolean failFast, long filesize) {
        super();
