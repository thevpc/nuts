...
@NUnused
public class JCshFileOutputStreamScpOld extends OutputStream {
    ...
    public JCshFileOutputStreamScpOld(NConnectionString path, boolean mkdirs, boolean failFast, long filesize) {
        super();
    ...
    private boolean _start() throws JSchException, IOException {
        ...
        channel = JCshConnection.unwrap(connection).openExecChannel(command);
