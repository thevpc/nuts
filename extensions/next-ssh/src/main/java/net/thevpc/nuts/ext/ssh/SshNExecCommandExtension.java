...
public class SshNExecCommandExtension implements NExecCommandExtension {
    private String[] resolveNutsExecutableCommand(NExecCommandExtensionContext context) {
        NSession session = context.getSession();
        NExecCommand execCommand = context.getExecCommand();
...
//        NExecCommand execCommand = context.getExecCommand();
    ...
    public int exec0(NExecCommandExtensionContext context) {
        String target = context.getTarget();
        NAssert.requireNonBlank(target, "target");
        NConnexionString z = NConnexionString.of(target).orNull();
        NAssert.requireNonBlank(z, "target");
