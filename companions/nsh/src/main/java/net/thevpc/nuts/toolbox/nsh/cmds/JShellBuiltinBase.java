 ...
 * @author thevpc
 */
public abstract class JShellBuiltinBase implements JShellBuiltin {
    private static final Logger LOG = Logger.getLogger(JShellBuiltinBase.class.getName());
    ...
    public JShellBuiltinBase(String name, int supportLevel, Class<?> optionsSupplier) {
        this.name = name;
        this.supportLevel = supportLevel;
        this.optionsSupplier = ()->createOptions(optionsSupplier);
    }

    public JShellBuiltinBase(String name, Class<?> optionsSupplier) {
        this.name = name;
        this.supportLevel = DEFAULT_SUPPORT;
        this.optionsSupplier = ()->createOptions(optionsSupplier);
    }
    public JShellBuiltinBase(String name, int supportLevel, Supplier<?> optionsSupplier) {
        this.name = name;
        this.supportLevel = supportLevel;
        this.optionsSupplier = (Supplier)optionsSupplier;
    }
    public JShellBuiltinBase(String name, Supplier<?> optionsSupplier) {
        this.name = name;
        this.supportLevel = DEFAULT_SUPPORT;
        this.optionsSupplier = (Supplier)optionsSupplier;
    }
    ...
    public void autoComplete(JShellExecutionContext context, NCmdLineAutoComplete autoComplete) {
        ...
        try {
            ...
            NCommandAutoCompleteComponent best = context.getSession().extensions().createServiceLoader(NCommandAutoCompleteComponent.class, JShellBuiltin.class, NCommandAutoCompleteComponent.class.getClassLoader())
                    .loadBest(JShellBuiltinBase.this);
            if (best != null) {
