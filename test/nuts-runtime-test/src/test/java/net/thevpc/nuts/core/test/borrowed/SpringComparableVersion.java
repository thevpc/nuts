package net.thevpc.nuts.core.test.borrowed;

import java.math.BigInteger;
import java.util.*;

public class SpringComparableVersion implements Comparable<SpringComparableVersion> {
    ...
    public SpringComparableVersion(String version) {
    ...
    public int compareTo(SpringComparableVersion o) {
    ...
    public boolean equals(Object o) {
        return (o instanceof SpringComparableVersion)
                && canonical.equals(((SpringComparableVersion) o).canonical);
    }
