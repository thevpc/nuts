//package net.vpc.app.nuts.extensions.server;
//
//
...
// *
// *
// * this a customized version of apache's MultipartStream.
// * Needed not to add all of apache dependency, besides needed to tweak-it a little
// */
//
///**
...
//        return (int) IOUtils.copy(istream, output,true,false);
//    }
//
//    /**
...
////            System.out.println("found boundary : " + (first - 1));
//            return first - 1;
//        }
////        System.out.println("not found boundary");
//        return -1;
//    }
//
//    /**
...
//            if (closed) {
//                throw new RuntimeException("ItemSkippedException");
//            }
//            if (available() == 0) {
//                if (makeAvailable() == 0) {
//                    return -1;
