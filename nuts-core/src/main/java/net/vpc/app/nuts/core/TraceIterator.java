...
public class TraceIterator<T> implements Iterator<T> {
    ...
    public TraceIterator(Iterator<T> curr, NutsWorkspace ws, PrintStream out, NutsOutputFormat format, NutsOutputListFormat conv, NutsFindCommand findCommand, NutsSession session) {
        this.curr = curr;
        this.ws = ws;
        this.out = out;
