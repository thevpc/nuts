 ...
 * @author vpc
 */
public class VersionInternalExecutable extends InternalExecutable {
    
    private final DefaultNutsExecCommand outer;

    public VersionInternalExecutable(String[] args, NutsWorkspace ws, NutsSession session, final DefaultNutsExecCommand outer) {
