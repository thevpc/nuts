 ...
 * @author vpc
 */
public class NutsObjectFormatBaseSimple extends NutsObjectFormatBase {
    ...
    public NutsObjectFormatBaseSimple(NutsOutputFormat t, NutsWorkspace ws, Object data) {
    ...
    public void print(Writer w) {
        switch (t) {
            ...
            case TABLE: {
                ...
                t.newRow().addCells(CoreCommonUtils.stringValue(data));
                t.print(w);
                break;
            }
            case TREE: {
