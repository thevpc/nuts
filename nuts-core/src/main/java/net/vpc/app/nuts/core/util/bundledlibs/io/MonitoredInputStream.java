...
import net.vpc.app.nuts.core.util.FixedInputStreamMetadata;
import net.vpc.app.nuts.core.util.InputStreamMetadata;
import net.vpc.app.nuts.core.util.InputStreamMetadataAware;
