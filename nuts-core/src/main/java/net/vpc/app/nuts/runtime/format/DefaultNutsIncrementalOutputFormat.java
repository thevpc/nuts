...
import net.vpc.app.nuts.runtime.format.json.DefaultSearchFormatJson;
import net.vpc.app.nuts.runtime.format.plain.DefaultSearchFormatPlain;
import net.vpc.app.nuts.runtime.format.props.DefaultSearchFormatProps;
import net.vpc.app.nuts.runtime.format.table.DefaultSearchFormatTable;
import net.vpc.app.nuts.runtime.format.tree.DefaultSearchFormatTree;
import net.vpc.app.nuts.runtime.format.xml.DefaultSearchFormatXml;
