 ...
 */
public class NutsAnsiUnixStripperTermPrintStream extends FormattedPrintStream implements NutsFormatFilteredPrintStream, OutputStreamTransparentAdapter {
    private OutputStream out;
    public NutsAnsiUnixStripperTermPrintStream(OutputStream out) {
        super(out,FPrint.RENDERER_ANSI_STRIPPER,FPrint.PARSER_DEFAULT);
        this.out=out;
    }
