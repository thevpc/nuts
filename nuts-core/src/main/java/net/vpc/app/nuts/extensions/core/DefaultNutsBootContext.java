...
public final class DefaultNutsBootContext implements NutsBootContext {
    ...
    private final StoreLocationStrategy storeLocationStrategy;
    private final StoreLocationLayout storeLocationLayout;
    ...
    public DefaultNutsBootContext(String home, String workspace, NutsId bootAPI, NutsId bootRuntime, String bootRuntimeDependencies, String bootRepositories, String bootJavaCommand, String bootJavaOptions,
                                  String[] locations, StoreLocationStrategy storeLocationStrategy, StoreLocationLayout storeLocationLayout
    ) {
        this.home = home;
        ...
        storeLocations = new String[StoreFolder.values().length];
    ...
    public DefaultNutsBootContext(NutsBootConfig c) {
        ...
        for (int i = 0; i < storeLocations.length; i++) {
            switch (StoreFolder.values()[i]) {
                ...
                default: {
                    throw new NutsIllegalArgumentException("Unsupported " + StoreFolder.values()[i]);
                }
            }
        }
    }
