...
import net.vpc.app.nuts.core.util.bundledlibs.fprint.TextFormatList;
import net.vpc.app.nuts.core.util.bundledlibs.fprint.TextFormats;
import net.vpc.app.nuts.core.util.bundledlibs.fprint.renderer.ansi.*;
