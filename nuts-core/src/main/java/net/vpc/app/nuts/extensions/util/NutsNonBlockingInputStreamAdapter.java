...
public class NutsNonBlockingInputStreamAdapter extends FilterInputStream implements NutsNonBlockingInputStream {

    private boolean hasMoreBytes = true;
    private boolean closed = false;
    private String name;

    public NutsNonBlockingInputStreamAdapter(String name, InputStream in) {
        super(in);
        this.name = name;
    }
