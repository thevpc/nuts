 ...
 * @author thevpc
 */
public class NDerbyMain extends RdbSupport<NDerbyConfig> {
    ...
    @Override
    protected String createJdbcURL(NDerbyConfig options) {
...
//            return true;
    ...
    @Override
    protected void revalidateOptions(NDerbyConfig options) {
