    ...
    public void exec(String[] args, NshExecutionContext context) {
        ...
        while (cmdLine.hasNext()) {
            if (context.configureFirst(cmdLine)) {
                ...
                code = true;
                context.session().getTerminal().setMode(NutsTerminalMode.FILTERED);
        ...
        if (cmdLine.isExecMode()) {
            if (showColors) {
                String colorsText = context.getWorkspace().io().loadFormattedString("/net/vpc/app/nuts/toolbox/nuts-help-colors.help", HelpCommand.class.getClassLoader(), "no help found");
