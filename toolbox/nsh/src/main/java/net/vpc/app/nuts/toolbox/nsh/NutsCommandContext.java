 ...
 */
public interface NutsCommandContext {

    String getServiceName();

    NutsCommandContext setServiceName(String serviceName);

    NutsSession getSession();

    NutsCommandContext setSession(NutsSession session);
    ...
    NutsConsole getConsole();

    void setConsole(NutsConsole console);
