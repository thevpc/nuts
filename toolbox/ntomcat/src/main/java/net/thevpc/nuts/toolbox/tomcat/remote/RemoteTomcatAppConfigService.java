...
public class RemoteTomcatAppConfigService extends RemoteTomcatServiceBase {
    ...
    public RemoteTomcatAppConfigService print(PrintStream out) {
        ...
        m.put("name", getName());
        m.putAll(ws.formats().element().fromElement(ws.formats().element().toElement(getConfig()), Map.class));
        ws.formats().object().setSession(context.getSession()).value(m).print(out);
        return this;
    }
