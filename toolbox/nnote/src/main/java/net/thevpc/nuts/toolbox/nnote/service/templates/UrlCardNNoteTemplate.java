    ...
    public void prepare(NNote n, NNoteService service) {
        ...
        NNoteObjectDocument doc = new NNoteObjectDocument().setDescriptor(
                new NNoteObjectDescriptor()
                        ...
                        .addField(new NNoteFieldDescriptor().setName(i18n.getString(prefix + "userName")).setType(NNoteObjectFieldType.TEXT))
                        .addField(new NNoteFieldDescriptor().setName(i18n.getString(prefix + "password")).setType(NNoteObjectFieldType.PASSWORD))
                        .addField(new NNoteFieldDescriptor().setName(i18n.getString(prefix + "url")).setType(NNoteObjectFieldType.URL))
